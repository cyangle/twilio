...
module Twilio
  class ListRecordingAddOnResultResponse
    ...
    # Optional properties
    @[JSON::Field(key: "add_on_results", type: Array(RecordingRecordingAddOnResult)?, presence: true, ignore_serialize: add_on_results.nil? && !add_on_results_present?, emit_null: true)]
    property add_on_results : Array(RecordingRecordingAddOnResult)?
    @[JSON::Field(ignore: true)]
    property? add_on_results_present : Bool = false
    ...
    def initialize(*, @add_on_results : Array(RecordingRecordingAddOnResult)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        add_on_results == o.add_on_results &&
        _end == o._end &&
    ...
    def hash
      [add_on_results, _end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
