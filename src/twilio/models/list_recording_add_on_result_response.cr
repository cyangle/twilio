...
module Twilio
  class ListRecordingAddOnResultResponse
    ...
    # Optional properties
    @[NASON::Field(key: "add_on_results", type: Array(RecordingRecordingAddOnResult)?, nillable: true)]
    ...
    def initialize(*, @add_on_results : Array(RecordingRecordingAddOnResult)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
