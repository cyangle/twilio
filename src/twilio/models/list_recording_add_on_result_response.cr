...
module Twilio
  ...
  class ListRecordingAddOnResultResponse
    ...
    # Optional properties
    @[JSON::Field(key: "add_on_results", type: Array(RecordingRecordingAddOnResult)?, presence: true, ignore_serialize: add_on_results.nil? && !add_on_results_present?)]
    ...
    def_hash(@add_on_results, @_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
