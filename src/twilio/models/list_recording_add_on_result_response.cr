...
module Twilio
  class ListRecordingAddOnResultResponse
    ...
    @[JSON::Field(key: "add_on_results", type: Array(Twilio::RecordingRecordingAddOnResult)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter add_on_results : Array(Twilio::RecordingRecordingAddOnResult)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @add_on_results : Array(Twilio::RecordingRecordingAddOnResult)? = nil,
      @_end : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_add_on_results = @add_on_results).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "add_on_results", container: _add_on_results)) if _add_on_results.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_add_on_results = @add_on_results).nil?
        return false if _add_on_results.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _add_on_results)
      end
    ...
    def add_on_results=(add_on_results : Array(Twilio::RecordingRecordingAddOnResult)?)
      if add_on_results.nil?
        return @add_on_results = nil
      end
      _add_on_results = add_on_results.not_nil!
      OpenApi::ContainerValidator.validate(container: _add_on_results) if _add_on_results.is_a?(Array)
      @add_on_results = _add_on_results
    end
