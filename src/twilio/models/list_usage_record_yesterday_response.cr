...
module Twilio
  class ListUsageRecordYesterdayResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(Twilio::UsageUsageRecordUsageRecordYesterday)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter usage_records : Array(Twilio::UsageUsageRecordUsageRecordYesterday)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @usage_records : Array(Twilio::UsageUsageRecordUsageRecordYesterday)? = nil,
      @_end : Int32? = nil,
    ...
    def usage_records=(usage_records : Array(Twilio::UsageUsageRecordUsageRecordYesterday)?)
