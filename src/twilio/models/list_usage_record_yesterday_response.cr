...
module Twilio
  class ListUsageRecordYesterdayResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(UsageUsageRecordUsageRecordYesterday)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter usage_records : Array(UsageUsageRecordUsageRecordYesterday)? = nil
    ...
    def initialize(
      *,
      ...
      @start : Int32? = nil,
      @uri : String? = nil,
      @usage_records : Array(UsageUsageRecordUsageRecordYesterday)? = nil
    )
    end
    ...
    def usage_records=(usage_records : Array(UsageUsageRecordUsageRecordYesterday)?)
