...
module Twilio
  class TokenIceServers
    include NASON::Serializable

    # Optional properties
    @[NASON::Field(key: "credential", type: String?, nillable: true)]
    property credential : String?

    @[NASON::Field(key: "url", type: String?, nillable: true)]
    property url : String?

    @[NASON::Field(key: "urls", type: String?, nillable: true)]
    property urls : String?

    @[NASON::Field(key: "username", type: String?, nillable: true)]
