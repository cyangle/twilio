...
module Twilio
  class SipSipDomainSipIpAccessControlListMapping
    ...
    @[NASON::Field(key: "domain_sid", type: String? | Null, nillable: true)]
    property domain_sid : String? | Null
    ...
    def initialize(*, @account_sid : String? | Null = nil, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @domain_sid : String? | Null = nil, @friendly_name : String? | Null = nil, @sid : String? | Null = nil, @uri : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@domain_sid.nil? && !@domain_sid.null? && @domain_sid.to_s.size > 34
      ...
      if !@domain_sid.nil? && !@domain_sid.null? && @domain_sid !~ pattern
    ...
    def valid?
      ...
      return false if !@domain_sid.nil? && !@domain_sid.null? && @domain_sid.to_s.size > 34
      return false if !@domain_sid.nil? && !@domain_sid.null? && @domain_sid.to_s.size < 34
      return false if !@domain_sid.nil? && !@domain_sid.null? && @domain_sid !~ /^SD[0-9a-fA-F]{32}$/
      return false if !@sid.nil? && !@sid.null? && @sid.to_s.size > 34
      return false if !@sid.nil? && !@sid.null? && @sid.to_s.size < 34
      return false if !@sid.nil? && !@sid.null? && @sid !~ /^AL[0-9a-fA-F]{32}$/
      true
    end
