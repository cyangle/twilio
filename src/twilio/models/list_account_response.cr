...
module Twilio
  class ListAccountResponse
    ...
    @[JSON::Field(key: "accounts", type: Array(Twilio::Account)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter accounts : Array(Twilio::Account)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @accounts : Array(Twilio::Account)? = nil,
      @_end : Int32? = nil,
    ...
    def accounts=(accounts : Array(Twilio::Account)?)
      if accounts.nil?
        return @accounts = nil
      end
      _accounts = accounts.not_nil!
      OpenApi::ContainerValidator.validate(container: _accounts) if _accounts.is_a?(Array)
      @accounts = _accounts
    end
    ...
    def_equals_and_hash(@accounts, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
