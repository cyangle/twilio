...
module Twilio
  class ListAccountResponse
    ...
    # Optional properties
    @[JSON::Field(key: "accounts", type: Array(Account)?, presence: true, ignore_serialize: accounts.nil? && !accounts_present?, emit_null: true)]
    property accounts : Array(Account)?
    @[JSON::Field(ignore: true)]
    property? accounts_present : Bool = false
    ...
    def initialize(*, @accounts : Array(Account)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [accounts, _end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
