...
module Twilio
  ...
  class ListAccountResponse
    ...
    # Optional properties
    @[JSON::Field(key: "accounts", type: Array(Account)?, presence: true, ignore_serialize: accounts.nil? && !accounts_present?)]
    ...
    def_equals_and_hash(@accounts, @_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
