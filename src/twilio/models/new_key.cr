...
module Twilio
  class NewKey
    ...
    @[NASON::Field(key: "secret", type: String? | Null, nillable: true)]
    property secret : String? | Null
    ...
    def initialize(*, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @friendly_name : String? | Null = nil, @secret : String? | Null = nil, @sid : String? | Null = nil)
    end
    ...
    def valid?
      ...
      return false if !@sid.nil? && !@sid.null? && @sid.to_s.size < 34
      return false if !@sid.nil? && !@sid.null? && @sid !~ /^SK[0-9a-fA-F]{32}$/
      true
    end
    ...
    def hash
      [date_created, date_updated, friendly_name, secret, sid].hash
    end
