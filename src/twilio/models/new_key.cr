...
module Twilio
  class NewKey
    ...
    @[JSON::Field(key: "secret", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: secret.nil? && !secret_present?)]
    ...
    def_equals_and_hash(@sid, @sid_present, @friendly_name, @friendly_name_present, @date_created, @date_created_present, @date_updated, @date_updated_present, @secret, @secret_present)
  end
end
