...
module Twilio
  ...
  class AvailablePhoneNumberCountryAvailablePhoneNumberLocalCapabilities
    ...
    # Optional properties
    @[NASON::Field(key: "fax", type: Bool?, nillable: true)]
    property fax : Bool?

    @[NASON::Field(key: "mms", type: Bool?, nillable: true)]
    property mms : Bool?

    @[NASON::Field(key: "sms", type: Bool?, nillable: true)]
    property sms : Bool?

    @[NASON::Field(key: "voice", type: Bool?, nillable: true)]
    property voice : Bool?
