...
module Twilio
  class ListDependentPhoneNumberResponse
    ...
    # Optional properties
    @[NASON::Field(key: "dependent_phone_numbers", type: Array(AddressDependentPhoneNumber)?, nillable: true)]
    ...
    def initialize(*, @dependent_phone_numbers : Array(AddressDependentPhoneNumber)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
