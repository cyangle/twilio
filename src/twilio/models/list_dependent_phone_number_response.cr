...
module Twilio
  class ListDependentPhoneNumberResponse
    ...
    @[JSON::Field(key: "dependent_phone_numbers", type: Array(AddressDependentPhoneNumber)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter dependent_phone_numbers : Array(AddressDependentPhoneNumber)? = nil
    ...
    def dependent_phone_numbers=(dependent_phone_numbers : Array(AddressDependentPhoneNumber)?)
