...
module Twilio
  ...
  class ListDependentPhoneNumberResponse
    ...
    # Optional properties
    @[JSON::Field(key: "dependent_phone_numbers", type: Array(AddressDependentPhoneNumber)?, presence: true, ignore_serialize: dependent_phone_numbers.nil? && !dependent_phone_numbers_present?)]
    ...
    def_hash(@dependent_phone_numbers, @_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
