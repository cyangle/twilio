...
module Twilio
  class ListDependentPhoneNumberResponse
    ...
    # Optional properties
    @[JSON::Field(key: "dependent_phone_numbers", type: Array(AddressDependentPhoneNumber)?, presence: true, ignore_serialize: dependent_phone_numbers.nil? && !dependent_phone_numbers_present?, emit_null: true)]
    property dependent_phone_numbers : Array(AddressDependentPhoneNumber)?
    @[JSON::Field(ignore: true)]
    property? dependent_phone_numbers_present : Bool = false
    ...
    def initialize(*, @dependent_phone_numbers : Array(AddressDependentPhoneNumber)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        dependent_phone_numbers == o.dependent_phone_numbers &&
        _end == o._end &&
    ...
    def hash
      [dependent_phone_numbers, _end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
