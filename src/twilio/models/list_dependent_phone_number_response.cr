...
module Twilio
  class ListDependentPhoneNumberResponse
    ...
    @[JSON::Field(key: "dependent_phone_numbers", type: Array(Twilio::AddressDependentPhoneNumber)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter dependent_phone_numbers : Array(Twilio::AddressDependentPhoneNumber)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @dependent_phone_numbers : Array(Twilio::AddressDependentPhoneNumber)? = nil,
      @_end : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_dependent_phone_numbers = @dependent_phone_numbers).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "dependent_phone_numbers", container: _dependent_phone_numbers)) if _dependent_phone_numbers.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_dependent_phone_numbers = @dependent_phone_numbers).nil?
        return false if _dependent_phone_numbers.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _dependent_phone_numbers)
      end
    ...
    # @param [Object] dependent_phone_numbers Object to be assigned
    def dependent_phone_numbers=(dependent_phone_numbers : Array(Twilio::AddressDependentPhoneNumber)?)
      if dependent_phone_numbers.nil?
        return @dependent_phone_numbers = nil
      end
      _dependent_phone_numbers = dependent_phone_numbers.not_nil!
      OpenApi::ContainerValidator.validate(container: _dependent_phone_numbers) if _dependent_phone_numbers.is_a?(Array)
      @dependent_phone_numbers = _dependent_phone_numbers
    end
    ...
    def_equals_and_hash(@dependent_phone_numbers, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
