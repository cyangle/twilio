...
module Twilio
  class ConferenceEnumReasonConferenceEnded
    ...
    def self.from_json(value : JSON::PullParser) : ConferenceEnumReasonConferenceEnded
      new(value)
    end

    def self.to_json(value : ConferenceEnumReasonConferenceEnded, json : JSON::Builder) : Nil
      value.to_json(json)
    end
    ...
    def validate : Nil
      OpenApi::EnumValidator.validate("conference_enum_reason_conference_ended", data, VALID_VALUES, false)
    end
