...
module Twilio
  class RecordingRecordingAddOnResultRecordingAddOnResultPayload
    ...
    def list_invalid_properties
      ...
      if _add_on_result_sid = @add_on_result_sid
        if _add_on_result_sid.to_s.size > 34
    ...
    def valid?
      ...
      if _add_on_result_sid = @add_on_result_sid
        return false if _add_on_result_sid.to_s.size > 34
        return false if _add_on_result_sid.to_s.size < 34
        return false if _add_on_result_sid !~ /^XR[0-9a-fA-F]{32}$/
      end
      if _add_on_sid = @add_on_sid
      ...
      if _sid = @sid
        ...
        return false if _sid.to_s.size < 34
        return false if _sid !~ /^XH[0-9a-fA-F]{32}$/
      end
