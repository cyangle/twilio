...
module Twilio
  class ListQueueResponse
    ...
    @[JSON::Field(key: "queues", type: Array(Queue)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter queues : Array(Queue)? = nil
