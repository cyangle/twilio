...
module Twilio
  ...
  class ListQueueResponse
    ...
    @[JSON::Field(key: "queues", type: Array(Queue)?, presence: true, ignore_serialize: queues.nil? && !queues_present?)]
    ...
    def_equals_and_hash(@_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @queues, @start, @uri)
  end
end
