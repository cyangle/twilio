...
module Twilio
  class ListQueueResponse
    ...
    @[NASON::Field(key: "queues", type: Array(Queue)?, nillable: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @queues : Array(Queue)? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
