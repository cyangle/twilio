...
module Twilio
  class ListQueueResponse
    ...
    @[JSON::Field(key: "queues", type: Array(Queue)?, presence: true, ignore_serialize: queues.nil? && !queues_present?, emit_null: true)]
    property queues : Array(Queue)?
    @[JSON::Field(ignore: true)]
    property? queues_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @queues : Array(Queue)? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [_end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, queues, start, uri].hash
    end
