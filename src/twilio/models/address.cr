...
module Twilio
  class Address
    ...
    @[NASON::Field(key: "emergency_enabled", type: Bool? | Null, nillable: true)]
    property emergency_enabled : Bool? | Null
    ...
    @[NASON::Field(key: "street", type: String? | Null, nillable: true)]
    ...
    @[NASON::Field(key: "validated", type: Bool? | Null, nillable: true)]
    property validated : Bool? | Null

    # Whether the address has been verified to comply with regulation
    @[NASON::Field(key: "verified", type: Bool? | Null, nillable: true)]
    property verified : Bool? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @account_sid : String? | Null = nil, @city : String? | Null = nil, @customer_name : String? | Null = nil, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @emergency_enabled : Bool? | Null = nil, @friendly_name : String? | Null = nil, @iso_country : String? | Null = nil, @postal_code : String? | Null = nil, @region : String? | Null = nil, @sid : String? | Null = nil, @street : String? | Null = nil, @uri : String? | Null = nil, @validated : Bool? | Null = nil, @verified : Bool? | Null = nil)
    end
    ...
    def valid?
      ...
      return false if !@sid.nil? && !@sid.null? && @sid.to_s.size < 34
      return false if !@sid.nil? && !@sid.null? && @sid !~ /^AD[0-9a-fA-F]{32}$/
      true
    end
