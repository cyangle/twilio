...
module Twilio
  class Address
    ...
    def initialize(*, @account_sid : String? | Null = nil, @city : String? | Null = nil, @customer_name : String? | Null = nil, @date_created : Time? | Null = nil, @date_updated : Time? | Null = nil, @emergency_enabled : Bool? | Null = nil, @friendly_name : String? | Null = nil, @iso_country : String? | Null = nil, @postal_code : String? | Null = nil, @region : String? | Null = nil, @sid : String? | Null = nil, @street : String? | Null = nil, @uri : String? | Null = nil, @validated : Bool? | Null = nil, @verified : Bool? | Null = nil)
    end
