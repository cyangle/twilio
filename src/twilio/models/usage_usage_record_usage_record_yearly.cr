...
module Twilio
  class UsageUsageRecordUsageRecordYearly
    ...
    @[JSON::Field(key: "category", type: Twilio::UsageRecordYearlyEnumCategory?, default: nil, required: false, nullable: false, emit_null: false)]
    getter category : Twilio::UsageRecordYearlyEnumCategory? = nil
    ...
    def category=(category : Twilio::UsageRecordYearlyEnumCategory?)
      if category.nil?
        return @category = nil
      end
