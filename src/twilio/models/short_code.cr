...
module Twilio
  class ShortCode
    ...
    @[NASON::Field(key: "short_code", type: String? | Null, nillable: true)]
    property short_code : String? | Null
    ...
    def initialize(*, @account_sid : String? | Null = nil, @api_version : String? | Null = nil, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @friendly_name : String? | Null = nil, @short_code : String? | Null = nil, @sid : String? | Null = nil, @sms_fallback_method : String? | Null = nil, @sms_fallback_url : String? | Null = nil, @sms_method : String? | Null = nil, @sms_url : String? | Null = nil, @uri : String? | Null = nil)
    end
    ...
    def valid?
      ...
      return false if !@sid.nil? && !@sid.null? && @sid.to_s.size < 34
      return false if !@sid.nil? && !@sid.null? && @sid !~ /^SC[0-9a-fA-F]{32}$/
