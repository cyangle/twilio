...
module Twilio
  class ListSipCredentialListResponse
    ...
    @[JSON::Field(key: "credential_lists", type: Array(SipSipCredentialList)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter credential_lists : Array(SipSipCredentialList)? = nil
    ...
    def credential_lists=(credential_lists : Array(SipSipCredentialList)?)
