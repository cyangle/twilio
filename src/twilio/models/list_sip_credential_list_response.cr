...
module Twilio
  ...
  class ListSipCredentialListResponse
    ...
    # Optional properties
    @[JSON::Field(key: "credential_lists", type: Array(SipSipCredentialList)?, presence: true, ignore_serialize: credential_lists.nil? && !credential_lists_present?)]
    ...
    def_hash(@credential_lists, @_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
