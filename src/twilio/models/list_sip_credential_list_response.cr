...
module Twilio
  class ListSipCredentialListResponse
    ...
    # Optional properties
    @[JSON::Field(key: "credential_lists", type: Array(SipSipCredentialList)?, presence: true, ignore_serialize: credential_lists.nil? && !credential_lists_present?, emit_null: true)]
    property credential_lists : Array(SipSipCredentialList)?
    @[JSON::Field(ignore: true)]
    property? credential_lists_present : Bool = false
    ...
    def initialize(*, @credential_lists : Array(SipSipCredentialList)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        credential_lists == o.credential_lists &&
        _end == o._end &&
    ...
    def hash
      [credential_lists, _end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
