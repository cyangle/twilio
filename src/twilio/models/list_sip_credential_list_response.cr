...
module Twilio
  class ListSipCredentialListResponse
    ...
    @[JSON::Field(key: "credential_lists", type: Array(Twilio::SipSipCredentialList)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter credential_lists : Array(Twilio::SipSipCredentialList)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @credential_lists : Array(Twilio::SipSipCredentialList)? = nil,
      @_end : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_credential_lists = @credential_lists).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "credential_lists", container: _credential_lists)) if _credential_lists.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_credential_lists = @credential_lists).nil?
        return false if _credential_lists.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _credential_lists)
      end
    ...
    # @param [Object] credential_lists Object to be assigned
    def credential_lists=(credential_lists : Array(Twilio::SipSipCredentialList)?)
      if credential_lists.nil?
        return @credential_lists = nil
      end
      _credential_lists = credential_lists.not_nil!
      OpenApi::ContainerValidator.validate(container: _credential_lists) if _credential_lists.is_a?(Array)
      @credential_lists = _credential_lists
    end
    ...
    def_equals_and_hash(@credential_lists, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
