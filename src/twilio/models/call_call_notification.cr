...
module Twilio
  class CallCallNotification
    ...
    def initialize(*, @account_sid : String? | Null = nil, @api_version : String? | Null = nil, @call_sid : String? | Null = nil, @date_created : Time? | Null = nil, @date_updated : Time? | Null = nil, @error_code : String? | Null = nil, @log : String? | Null = nil, @message_date : Time? | Null = nil, @message_text : String? | Null = nil, @more_info : String? | Null = nil, @request_method : String? | Null = nil, @request_url : String? | Null = nil, @sid : String? | Null = nil, @uri : String? | Null = nil)
    end
