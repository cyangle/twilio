...
module Twilio
  class CallCallNotification
    ...
    @[NASON::Field(key: "message_date", type: String? | Null, nillable: true)]
    property message_date : String? | Null
    ...
    def initialize(*, @account_sid : String? | Null = nil, @api_version : String? | Null = nil, @call_sid : String? | Null = nil, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @error_code : String? | Null = nil, @log : String? | Null = nil, @message_date : String? | Null = nil, @message_text : String? | Null = nil, @more_info : String? | Null = nil, @request_method : String? | Null = nil, @request_url : String? | Null = nil, @sid : String? | Null = nil, @uri : String? | Null = nil)
    end
