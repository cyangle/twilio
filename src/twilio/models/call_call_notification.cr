...
module Twilio
  ...
  class CallCallNotification
    ...
    def_equals_and_hash(@account_sid, @api_version, @call_sid, @date_created, @date_updated, @error_code, @log, @message_date, @message_text, @more_info, @request_method, @request_url, @sid, @uri)
  end
end
