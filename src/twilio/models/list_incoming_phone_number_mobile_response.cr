...
module Twilio
  class ListIncomingPhoneNumberMobileResponse
    ...
    @[JSON::Field(key: "incoming_phone_numbers", type: Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberMobile)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter incoming_phone_numbers : Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberMobile)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @incoming_phone_numbers : Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberMobile)? = nil,
      @_end : Int32? = nil,
    ...
    def incoming_phone_numbers=(incoming_phone_numbers : Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberMobile)?)
