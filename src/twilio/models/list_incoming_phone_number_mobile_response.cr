...
module Twilio
  ...
  class ListIncomingPhoneNumberMobileResponse
    ...
    @[JSON::Field(key: "incoming_phone_numbers", type: Array(IncomingPhoneNumberIncomingPhoneNumberMobile)?, presence: true, ignore_serialize: incoming_phone_numbers.nil? && !incoming_phone_numbers_present?)]
