...
module Twilio
  class ListIncomingPhoneNumberMobileResponse
    ...
    @[JSON::Field(key: "incoming_phone_numbers", type: Array(IncomingPhoneNumberIncomingPhoneNumberMobile)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter incoming_phone_numbers : Array(IncomingPhoneNumberIncomingPhoneNumberMobile)? = nil
    ...
    def incoming_phone_numbers=(incoming_phone_numbers : Array(IncomingPhoneNumberIncomingPhoneNumberMobile)?)
