...
module Twilio
  class QueueMember
    ...
    @[NASON::Field(key: "date_enqueued", type: String? | Null, nillable: true)]
    property date_enqueued : String? | Null
    ...
    def initialize(*, @call_sid : String? | Null = nil, @date_enqueued : String? | Null = nil, @position : Int32? | Null = nil, @queue_sid : String? | Null = nil, @uri : String? | Null = nil, @wait_time : Int32? | Null = nil)
    end
