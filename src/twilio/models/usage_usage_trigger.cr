...
module Twilio
  class UsageUsageTrigger
    ...
    @[NASON::Field(key: "date_fired", type: String? | Null, nillable: true)]
    property date_fired : String? | Null
    ...
    def initialize(*, @account_sid : String? | Null = nil, @api_version : String? | Null = nil, @callback_method : String? | Null = nil, @callback_url : String? | Null = nil, @current_value : String? | Null = nil, @date_created : String? | Null = nil, @date_fired : String? | Null = nil, @date_updated : String? | Null = nil, @friendly_name : String? | Null = nil, @recurring : String? | Null = nil, @sid : String? | Null = nil, @trigger_by : String? | Null = nil, @trigger_value : String? | Null = nil, @uri : String? | Null = nil, @usage_category : String? | Null = nil, @usage_record_uri : String? | Null = nil)
    end
