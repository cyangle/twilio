...
module Twilio
  class ListRecordingAddOnResultPayloadResponse
    ...
    @[JSON::Field(key: "payloads", type: Array(RecordingRecordingAddOnResultRecordingAddOnResultPayload)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter payloads : Array(RecordingRecordingAddOnResultRecordingAddOnResultPayload)? = nil
    ...
    def payloads=(payloads : Array(RecordingRecordingAddOnResultRecordingAddOnResultPayload)?)
      if payloads.nil?
        return @payloads = nil
      end
      @payloads = payloads
