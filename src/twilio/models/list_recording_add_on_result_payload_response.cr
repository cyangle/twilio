...
module Twilio
  class ListRecordingAddOnResultPayloadResponse
    ...
    @[JSON::Field(key: "payloads", type: Array(RecordingRecordingAddOnResultRecordingAddOnResultPayload)?, presence: true, ignore_serialize: payloads.nil? && !payloads_present?, emit_null: true)]
    property payloads : Array(RecordingRecordingAddOnResultRecordingAddOnResultPayload)?
    @[JSON::Field(ignore: true)]
    property? payloads_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @payloads : Array(RecordingRecordingAddOnResultRecordingAddOnResultPayload)? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [_end, first_page_uri, next_page_uri, page, page_size, payloads, previous_page_uri, start, uri].hash
    end
