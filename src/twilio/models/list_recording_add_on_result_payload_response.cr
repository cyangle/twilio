...
module Twilio
  ...
  class ListRecordingAddOnResultPayloadResponse
    ...
    @[JSON::Field(key: "payloads", type: Array(RecordingRecordingAddOnResultRecordingAddOnResultPayload)?, presence: true, ignore_serialize: payloads.nil? && !payloads_present?)]
    ...
    def_equals_and_hash(@_end, @first_page_uri, @next_page_uri, @page, @page_size, @payloads, @previous_page_uri, @start, @uri)
  end
end
