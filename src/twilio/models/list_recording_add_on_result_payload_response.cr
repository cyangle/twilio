...
module Twilio
  class ListRecordingAddOnResultPayloadResponse
    ...
    @[NASON::Field(key: "payloads", type: Array(RecordingRecordingAddOnResultRecordingAddOnResultPayload)?, nillable: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @payloads : Array(RecordingRecordingAddOnResultRecordingAddOnResultPayload)? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
