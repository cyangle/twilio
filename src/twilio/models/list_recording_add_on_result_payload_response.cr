...
require "./recording_recording_add_on_result_recording_add_on_result_payload"
...
module Twilio
  class ListRecordingAddOnResultPayloadResponse
    ...
    def payloads=(new_value : Array(Twilio::RecordingRecordingAddOnResultRecordingAddOnResultPayload)?)
