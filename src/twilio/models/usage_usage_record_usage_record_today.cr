...
module Twilio
  class UsageUsageRecordUsageRecordToday
    ...
    @[JSON::Field(key: "category", type: Twilio::UsageRecordTodayEnumCategory?, default: nil, required: false, nullable: false, emit_null: false)]
    getter category : Twilio::UsageRecordTodayEnumCategory? = nil
    ...
    def category=(category : Twilio::UsageRecordTodayEnumCategory?)
      if category.nil?
        return @category = nil
      end
