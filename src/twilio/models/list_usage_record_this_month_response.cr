...
module Twilio
  class ListUsageRecordThisMonthResponse
    ...
    @[NASON::Field(key: "usage_records", type: Array(UsageUsageRecordUsageRecordThisMonth)?, nillable: true)]
    property usage_records : Array(UsageUsageRecordUsageRecordThisMonth)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil, @usage_records : Array(UsageUsageRecordUsageRecordThisMonth)? = nil)
    end
