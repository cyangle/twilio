...
module Twilio
  class ListUsageRecordThisMonthResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(Twilio::UsageUsageRecordUsageRecordThisMonth)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter usage_records : Array(Twilio::UsageUsageRecordUsageRecordThisMonth)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @usage_records : Array(Twilio::UsageUsageRecordUsageRecordThisMonth)? = nil,
      @_end : Int32? = nil,
    ...
    def usage_records=(usage_records : Array(Twilio::UsageUsageRecordUsageRecordThisMonth)?)
