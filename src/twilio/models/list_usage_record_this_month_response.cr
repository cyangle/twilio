...
module Twilio
  ...
  class ListUsageRecordThisMonthResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(UsageUsageRecordUsageRecordThisMonth)?, presence: true, ignore_serialize: usage_records.nil? && !usage_records_present?)]
    ...
    def_hash(@_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri, @usage_records)
  end
end
