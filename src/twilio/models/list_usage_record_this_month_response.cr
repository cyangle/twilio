...
module Twilio
  class ListUsageRecordThisMonthResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(UsageUsageRecordUsageRecordThisMonth)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter usage_records : Array(UsageUsageRecordUsageRecordThisMonth)? = nil
    ...
    def usage_records=(usage_records : Array(UsageUsageRecordUsageRecordThisMonth)?)
