...
module Twilio
  class AvailablePhoneNumberCountry
    ...
    def_equals_and_hash(@country_code, @country_code_present, @country, @country_present, @uri, @uri_present, @beta, @beta_present, @subresource_uris, @subresource_uris_present)
  end
end
