...
module Twilio
  class ListUsageTriggerResponse
    ...
    @[JSON::Field(key: "usage_triggers", type: Array(UsageUsageTrigger)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter usage_triggers : Array(UsageUsageTrigger)? = nil
    ...
    def usage_triggers=(usage_triggers : Array(UsageUsageTrigger)?)
