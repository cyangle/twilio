...
module Twilio
  class ListAvailablePhoneNumberNationalResponse
    ...
    @[JSON::Field(key: "available_phone_numbers", type: Array(AvailablePhoneNumberCountryAvailablePhoneNumberNational)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter available_phone_numbers : Array(AvailablePhoneNumberCountryAvailablePhoneNumberNational)? = nil
    ...
    def available_phone_numbers=(available_phone_numbers : Array(AvailablePhoneNumberCountryAvailablePhoneNumberNational)?)
