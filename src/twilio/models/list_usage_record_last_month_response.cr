...
module Twilio
  class ListUsageRecordLastMonthResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(UsageUsageRecordUsageRecordLastMonth)?, presence: true, ignore_serialize: usage_records.nil? && !usage_records_present?, emit_null: true)]
    property usage_records : Array(UsageUsageRecordUsageRecordLastMonth)?
    @[JSON::Field(ignore: true)]
    property? usage_records_present : Bool = false

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil, @usage_records : Array(UsageUsageRecordUsageRecordLastMonth)? = nil)
    end
    ...
    def hash
      [_end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri, usage_records].hash
    end
