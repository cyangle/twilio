...
module Twilio
  class ListUsageRecordLastMonthResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(UsageUsageRecordUsageRecordLastMonth)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter usage_records : Array(UsageUsageRecordUsageRecordLastMonth)? = nil
    ...
    def usage_records=(usage_records : Array(UsageUsageRecordUsageRecordLastMonth)?)
