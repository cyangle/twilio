...
module Twilio
  class ListUsageRecordLastMonthResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(Twilio::UsageUsageRecordUsageRecordLastMonth)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter usage_records : Array(Twilio::UsageUsageRecordUsageRecordLastMonth)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @usage_records : Array(Twilio::UsageUsageRecordUsageRecordLastMonth)? = nil,
      @_end : Int32? = nil,
    ...
    def usage_records=(usage_records : Array(Twilio::UsageUsageRecordUsageRecordLastMonth)?)
