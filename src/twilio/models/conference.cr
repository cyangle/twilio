...
module Twilio
  class Conference
    ...
    @[NASON::Field(key: "call_sid_ending_conference", type: String? | Null, nillable: true)]
    property call_sid_ending_conference : String? | Null
    ...
    @[NASON::Field(key: "reason_conference_ended", type: String? | Null, nillable: true)]
    property reason_conference_ended : String? | Null
    ...
    def initialize(*, @account_sid : String? | Null = nil, @api_version : String? | Null = nil, @call_sid_ending_conference : String? | Null = nil, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @friendly_name : String? | Null = nil, @reason_conference_ended : String? | Null = nil, @region : String? | Null = nil, @sid : String? | Null = nil, @status : String? | Null = nil, @subresource_uris : Hash(String, String)? | Null = nil, @uri : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@call_sid_ending_conference.nil? && !@call_sid_ending_conference.null? && @call_sid_ending_conference.to_s.size > 34
      ...
      if !@call_sid_ending_conference.nil? && !@call_sid_ending_conference.null? && @call_sid_ending_conference !~ pattern
    ...
    def valid?
      ...
      return false if !@call_sid_ending_conference.nil? && !@call_sid_ending_conference.null? && @call_sid_ending_conference.to_s.size > 34
      return false if !@call_sid_ending_conference.nil? && !@call_sid_ending_conference.null? && @call_sid_ending_conference.to_s.size < 34
      return false if !@call_sid_ending_conference.nil? && !@call_sid_ending_conference.null? && @call_sid_ending_conference !~ /^CA[0-9a-fA-F]{32}$/
      ...
      return false if !@sid.nil? && !@sid.null? && @sid.to_s.size < 34
      return false if !@sid.nil? && !@sid.null? && @sid !~ /^CF[0-9a-fA-F]{32}$/
