...
module Twilio
  class Conference
    ...
    def_equals_and_hash(@account_sid, @account_sid_present, @date_created, @date_created_present, @date_updated, @date_updated_present, @api_version, @api_version_present, @friendly_name, @friendly_name_present, @region, @region_present, @sid, @sid_present, @status, @uri, @uri_present, @subresource_uris, @subresource_uris_present, @reason_conference_ended, @call_sid_ending_conference, @call_sid_ending_conference_present)
  end
end
