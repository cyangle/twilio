...
module Twilio
  ...
  class Conference
    ...
    def_equals_and_hash(@account_sid, @api_version, @call_sid_ending_conference, @date_created, @date_updated, @friendly_name, @reason_conference_ended, @region, @sid, @status, @subresource_uris, @uri)
  end
end
