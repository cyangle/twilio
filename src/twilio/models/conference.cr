...
module Twilio
  class Conference
    ...
    def initialize(*, @account_sid : String? | Null = nil, @api_version : String? | Null = nil, @call_sid_ending_conference : String? | Null = nil, @date_created : Time? | Null = nil, @date_updated : Time? | Null = nil, @friendly_name : String? | Null = nil, @reason_conference_ended : String? | Null = nil, @region : String? | Null = nil, @sid : String? | Null = nil, @status : String? | Null = nil, @subresource_uris : Hash(String, String)? | Null = nil, @uri : String? | Null = nil)
    end
