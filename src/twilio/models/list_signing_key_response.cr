...
module Twilio
  class ListSigningKeyResponse
    ...
    @[JSON::Field(key: "signing_keys", type: Array(Twilio::SigningKey)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter signing_keys : Array(Twilio::SigningKey)? = nil
    ...
    def initialize(
      *,
      ...
      @signing_keys : Array(Twilio::SigningKey)? = nil,
      @start : Int32? = nil,
      @uri : String? = nil
    )
    end
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_signing_keys = @signing_keys).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "signing_keys", container: _signing_keys)) if _signing_keys.is_a?(Array)
      end
    ...
    def valid? : Bool
      ...
      unless (_signing_keys = @signing_keys).nil?
        return false if _signing_keys.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _signing_keys)
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] signing_keys Object to be assigned
    def signing_keys=(signing_keys : Array(Twilio::SigningKey)?)
      if signing_keys.nil?
        return @signing_keys = nil
      end
      _signing_keys = signing_keys.not_nil!
      OpenApi::ContainerValidator.validate(container: _signing_keys) if _signing_keys.is_a?(Array)
    ...
    def_equals_and_hash(@_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @signing_keys, @start, @uri)
  end
end
