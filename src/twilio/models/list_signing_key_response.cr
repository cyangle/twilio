...
module Twilio
  class ListSigningKeyResponse
    ...
    @[JSON::Field(key: "signing_keys", type: Array(SigningKey)?, presence: true, ignore_serialize: signing_keys.nil? && !signing_keys_present?, emit_null: true)]
    ...
    def hash
      [_end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, signing_keys, start, uri].hash
    end
