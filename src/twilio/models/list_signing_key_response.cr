...
module Twilio
  class ListSigningKeyResponse
    ...
    @[JSON::Field(key: "signing_keys", type: Array(SigningKey)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter signing_keys : Array(SigningKey)? = nil
    ...
    def signing_keys=(signing_keys : Array(SigningKey)?)
      if signing_keys.nil?
