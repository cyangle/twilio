...
module Twilio
  ...
  class ListSigningKeyResponse
    ...
    @[JSON::Field(key: "signing_keys", type: Array(SigningKey)?, presence: true, ignore_serialize: signing_keys.nil? && !signing_keys_present?)]
    property signing_keys : Array(SigningKey)?

    @[JSON::Field(ignore: true)]
    property? signing_keys_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @signing_keys : Array(SigningKey)? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def_equals_and_hash(@_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @signing_keys, @start, @uri)
  end
end
