...
module Twilio
  class CallCallNotificationInstance
    ...
    @[JSON::Field(key: "error_code", type: String?, presence: true, ignore_serialize: error_code.nil? && !error_code_present?, emit_null: true)]
    property error_code : String?
    @[JSON::Field(ignore: true)]
    property? error_code_present : Bool = false

    # An integer log level
    @[JSON::Field(key: "log", type: String?, presence: true, ignore_serialize: log.nil? && !log_present?, emit_null: true)]
    property log : String?
    @[JSON::Field(ignore: true)]
    property? log_present : Bool = false

    # The date the notification was generated
    @[JSON::Field(key: "message_date", type: Time?, converter: Time::RFC2822Converter, presence: true, ignore_serialize: message_date.nil? && !message_date_present?, emit_null: true)]
    property message_date : Time?
    @[JSON::Field(ignore: true)]
    property? message_date_present : Bool = false

    # The text of the notification
    @[JSON::Field(key: "message_text", type: String?, presence: true, ignore_serialize: message_text.nil? && !message_text_present?, emit_null: true)]
    property message_text : String?
    @[JSON::Field(ignore: true)]
    property? message_text_present : Bool = false

    # A URL for more information about the error code
    @[JSON::Field(key: "more_info", type: String?, presence: true, ignore_serialize: more_info.nil? && !more_info_present?, emit_null: true)]
    property more_info : String?
    @[JSON::Field(ignore: true)]
    property? more_info_present : Bool = false

    # HTTP method used with the request url
    @[JSON::Field(key: "request_method", type: String?, presence: true, ignore_serialize: request_method.nil? && !request_method_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "request_url", type: String?, presence: true, ignore_serialize: request_url.nil? && !request_url_present?, emit_null: true)]
    property request_url : String?
    @[JSON::Field(ignore: true)]
    property? request_url_present : Bool = false

    # Twilio-generated HTTP variables sent to the server
    @[JSON::Field(key: "request_variables", type: String?, presence: true, ignore_serialize: request_variables.nil? && !request_variables_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "response_headers", type: String?, presence: true, ignore_serialize: response_headers.nil? && !response_headers_present?, emit_null: true)]
