...
module Twilio
  ...
  class CallCallNotificationInstance
    ...
    def_equals_and_hash(@account_sid, @api_version, @call_sid, @date_created, @date_updated, @error_code, @log, @message_date, @message_text, @more_info, @request_method, @request_url, @request_variables, @response_body, @response_headers, @sid, @uri)
  end
end
