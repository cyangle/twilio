  ...
  class SipSipIpAccessControlListSipIpAddress
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_ip_access_control_list_sid = @ip_access_control_list_sid).nil?
        ...
        if min_length_error = OpenApi::PrimitiveValidator.min_length_error("ip_access_control_list_sid", _ip_access_control_list_sid.to_s.size, MIN_LENGTH_FOR_IP_ACCESS_CONTROL_LIST_SID)
          invalid_properties.push(min_length_error)
        end

        if pattern_error = OpenApi::PrimitiveValidator.pattern_error("ip_access_control_list_sid", _ip_access_control_list_sid, PATTERN_FOR_IP_ACCESS_CONTROL_LIST_SID)
          invalid_properties.push(pattern_error)
        end
      end
