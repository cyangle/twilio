...
module Twilio
  class Message
    ...
    def_equals_and_hash(@body, @body_present, @num_segments, @num_segments_present, @direction, @from, @from_present, @to, @to_present, @date_updated, @date_updated_present, @price, @price_present, @error_message, @error_message_present, @uri, @uri_present, @account_sid, @account_sid_present, @num_media, @num_media_present, @status, @messaging_service_sid, @messaging_service_sid_present, @sid, @sid_present, @date_sent, @date_sent_present, @date_created, @date_created_present, @error_code, @error_code_present, @price_unit, @price_unit_present, @api_version, @api_version_present, @subresource_uris, @subresource_uris_present)
  end
end
