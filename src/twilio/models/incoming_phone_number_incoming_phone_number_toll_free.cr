...
module Twilio
  class IncomingPhoneNumberIncomingPhoneNumberTollFree
    ...
    @[JSON::Field(key: "address_requirements", type: Twilio::IncomingPhoneNumberTollFreeEnumAddressRequirement?, default: nil, required: false, nullable: false, emit_null: false)]
    getter address_requirements : Twilio::IncomingPhoneNumberTollFreeEnumAddressRequirement? = nil
    ...
    @[JSON::Field(key: "voice_receive_mode", type: Twilio::IncomingPhoneNumberTollFreeEnumVoiceReceiveMode?, default: nil, required: false, nullable: false, emit_null: false)]
    getter voice_receive_mode : Twilio::IncomingPhoneNumberTollFreeEnumVoiceReceiveMode? = nil
    ...
    @[JSON::Field(key: "emergency_status", type: Twilio::IncomingPhoneNumberTollFreeEnumEmergencyStatus?, default: nil, required: false, nullable: false, emit_null: false)]
    getter emergency_status : Twilio::IncomingPhoneNumberTollFreeEnumEmergencyStatus? = nil
    ...
    @[JSON::Field(key: "emergency_address_status", type: Twilio::IncomingPhoneNumberTollFreeEnumEmergencyAddressStatus?, default: nil, required: false, nullable: false, emit_null: false)]
    getter emergency_address_status : Twilio::IncomingPhoneNumberTollFreeEnumEmergencyAddressStatus? = nil
    ...
    def initialize(
      *,
      ...
      @address_requirements : Twilio::IncomingPhoneNumberTollFreeEnumAddressRequirement? = nil,
      ...
      @emergency_address_status : Twilio::IncomingPhoneNumberTollFreeEnumEmergencyAddressStatus? = nil,
    ...
    def address_sid=(address_sid : String?)
      ...
      OpenApi::PrimitiveValidator.validate_max_length("address_sid", _address_sid.to_s.size, MAX_LENGTH_FOR_ADDRESS_SID)
      OpenApi::PrimitiveValidator.validate_min_length("address_sid", _address_sid.to_s.size, MIN_LENGTH_FOR_ADDRESS_SID)
      OpenApi::PrimitiveValidator.validate_pattern("address_sid", _address_sid, PATTERN_FOR_ADDRESS_SID)
      @address_sid = _address_sid
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] address_requirements Object to be assigned
    def address_requirements=(address_requirements : Twilio::IncomingPhoneNumberTollFreeEnumAddressRequirement?)
    ...
    def capabilities=(capabilities : Twilio::IncomingPhoneNumberCapabilities?)
      if capabilities.nil?
    ...
    def identity_sid=(identity_sid : String?)
      ...
      OpenApi::PrimitiveValidator.validate_max_length("identity_sid", _identity_sid.to_s.size, MAX_LENGTH_FOR_IDENTITY_SID)
      OpenApi::PrimitiveValidator.validate_min_length("identity_sid", _identity_sid.to_s.size, MIN_LENGTH_FOR_IDENTITY_SID)
      OpenApi::PrimitiveValidator.validate_pattern("identity_sid", _identity_sid, PATTERN_FOR_IDENTITY_SID)
      @identity_sid = _identity_sid
    end
    ...
    def voice_receive_mode=(voice_receive_mode : Twilio::IncomingPhoneNumberTollFreeEnumVoiceReceiveMode?)
      ...
      @voice_receive_mode = _voice_receive_mode
    end
    ...
    def emergency_status=(emergency_status : Twilio::IncomingPhoneNumberTollFreeEnumEmergencyStatus?)
    ...
    def emergency_address_status=(emergency_address_status : Twilio::IncomingPhoneNumberTollFreeEnumEmergencyAddressStatus?)
      ...
      _emergency_address_status.validate
      @emergency_address_status = _emergency_address_status
    end
    ...
    def bundle_sid=(bundle_sid : String?)
      ...
      OpenApi::PrimitiveValidator.validate_max_length("bundle_sid", _bundle_sid.to_s.size, MAX_LENGTH_FOR_BUNDLE_SID)
      OpenApi::PrimitiveValidator.validate_min_length("bundle_sid", _bundle_sid.to_s.size, MIN_LENGTH_FOR_BUNDLE_SID)
      OpenApi::PrimitiveValidator.validate_pattern("bundle_sid", _bundle_sid, PATTERN_FOR_BUNDLE_SID)
      @bundle_sid = _bundle_sid
    end
    ...
    def_equals_and_hash(@account_sid, @account_sid_present, @address_sid, @address_sid_present, @address_requirements, @api_version, @api_version_present, @beta, @beta_present, @capabilities, @capabilities_present, @date_created, @date_created_present, @date_updated, @date_updated_present, @friendly_name, @friendly_name_present, @identity_sid, @identity_sid_present, @phone_number, @phone_number_present, @origin, @origin_present, @sid, @sid_present, @sms_application_sid, @sms_application_sid_present, @sms_fallback_method, @sms_fallback_method_present, @sms_fallback_url, @sms_fallback_url_present, @sms_method, @sms_method_present, @sms_url, @sms_url_present, @status_callback, @status_callback_present, @status_callback_method, @status_callback_method_present, @trunk_sid, @trunk_sid_present, @uri, @uri_present, @voice_receive_mode, @voice_application_sid, @voice_application_sid_present, @voice_caller_id_lookup, @voice_caller_id_lookup_present, @voice_fallback_method, @voice_fallback_method_present, @voice_fallback_url, @voice_fallback_url_present, @voice_method, @voice_method_present, @voice_url, @voice_url_present, @emergency_status, @emergency_address_sid, @emergency_address_sid_present, @emergency_address_status, @bundle_sid, @bundle_sid_present, @status, @status_present)
  end
end
