...
module Twilio
  class IncomingPhoneNumberIncomingPhoneNumberTollFree
    ...
    @[NASON::Field(key: "capabilities", type: IncomingPhoneNumberCapabilities? | Null, nillable: true)]
    property capabilities : IncomingPhoneNumberCapabilities? | Null
