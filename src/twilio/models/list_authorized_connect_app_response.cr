...
module Twilio
  class ListAuthorizedConnectAppResponse
    ...
    @[JSON::Field(key: "authorized_connect_apps", type: Array(Twilio::AuthorizedConnectApp)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter authorized_connect_apps : Array(Twilio::AuthorizedConnectApp)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @authorized_connect_apps : Array(Twilio::AuthorizedConnectApp)? = nil,
      @_end : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_authorized_connect_apps = @authorized_connect_apps).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "authorized_connect_apps", container: _authorized_connect_apps)) if _authorized_connect_apps.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_authorized_connect_apps = @authorized_connect_apps).nil?
        return false if _authorized_connect_apps.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _authorized_connect_apps)
      end
    ...
    # @param [Object] authorized_connect_apps Object to be assigned
    def authorized_connect_apps=(authorized_connect_apps : Array(Twilio::AuthorizedConnectApp)?)
      if authorized_connect_apps.nil?
        return @authorized_connect_apps = nil
      end
      _authorized_connect_apps = authorized_connect_apps.not_nil!
      OpenApi::ContainerValidator.validate(container: _authorized_connect_apps) if _authorized_connect_apps.is_a?(Array)
      @authorized_connect_apps = _authorized_connect_apps
    end
    ...
    def_equals_and_hash(@authorized_connect_apps, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
