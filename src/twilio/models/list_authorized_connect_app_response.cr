...
module Twilio
  ...
  class ListAuthorizedConnectAppResponse
    ...
    # Optional properties
    @[JSON::Field(key: "authorized_connect_apps", type: Array(AuthorizedConnectApp)?, presence: true, ignore_serialize: authorized_connect_apps.nil? && !authorized_connect_apps_present?)]
    ...
    def_hash(@authorized_connect_apps, @_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
