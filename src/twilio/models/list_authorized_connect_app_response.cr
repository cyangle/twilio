...
module Twilio
  class ListAuthorizedConnectAppResponse
    ...
    @[JSON::Field(key: "authorized_connect_apps", type: Array(AuthorizedConnectApp)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter authorized_connect_apps : Array(AuthorizedConnectApp)? = nil
    ...
    def authorized_connect_apps=(authorized_connect_apps : Array(AuthorizedConnectApp)?)
