...
module Twilio
  class ListAuthorizedConnectAppResponse
    ...
    # Optional properties
    @[NASON::Field(key: "authorized_connect_apps", type: Array(AuthorizedConnectApp)?, nillable: true)]
    ...
    def initialize(*, @authorized_connect_apps : Array(AuthorizedConnectApp)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
