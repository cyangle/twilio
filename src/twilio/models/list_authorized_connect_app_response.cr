...
module Twilio
  class ListAuthorizedConnectAppResponse
    ...
    # Optional properties
    @[JSON::Field(key: "authorized_connect_apps", type: Array(AuthorizedConnectApp)?, presence: true, ignore_serialize: authorized_connect_apps.nil? && !authorized_connect_apps_present?, emit_null: true)]
    property authorized_connect_apps : Array(AuthorizedConnectApp)?
    @[JSON::Field(ignore: true)]
    property? authorized_connect_apps_present : Bool = false
    ...
    def initialize(*, @authorized_connect_apps : Array(AuthorizedConnectApp)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        authorized_connect_apps == o.authorized_connect_apps &&
        _end == o._end &&
    ...
    def hash
      [authorized_connect_apps, _end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
