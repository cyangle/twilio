...
module Twilio
  ...
  class SipSipDomainSipAuthSipAuthRegistrationsSipAuthRegistrationsCredentialListMapping
    ...
    def initialize(*, @account_sid : String? = nil, @date_created : Time? = nil, @date_updated : Time? = nil, @friendly_name : String? = nil, @sid : String? = nil)
    end
    ...
    def_equals_and_hash(@account_sid, @date_created, @date_updated, @friendly_name, @sid)
  end
end
