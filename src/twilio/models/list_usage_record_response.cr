...
module Twilio
  class ListUsageRecordResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(UsageUsageRecord)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter usage_records : Array(UsageUsageRecord)? = nil
    ...
    def usage_records=(usage_records : Array(UsageUsageRecord)?)
