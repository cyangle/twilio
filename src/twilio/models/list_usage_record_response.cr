...
module Twilio
  class ListUsageRecordResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(UsageUsageRecord)?, presence: true, ignore_serialize: usage_records.nil? && !usage_records_present?, emit_null: true)]
    property usage_records : Array(UsageUsageRecord)?
    @[JSON::Field(ignore: true)]
    property? usage_records_present : Bool = false

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil, @usage_records : Array(UsageUsageRecord)? = nil)
    end
