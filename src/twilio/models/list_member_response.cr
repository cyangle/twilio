...
module Twilio
  class ListMemberResponse
    ...
    @[JSON::Field(key: "queue_members", type: Array(QueueMember)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter queue_members : Array(QueueMember)? = nil
    ...
    def queue_members=(queue_members : Array(QueueMember)?)
