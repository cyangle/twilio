...
module Twilio
  ...
  class ListMemberResponse
    ...
    @[JSON::Field(key: "queue_members", type: Array(QueueMember)?, presence: true, ignore_serialize: queue_members.nil? && !queue_members_present?)]
    ...
    def_equals_and_hash(@_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @queue_members, @start, @uri)
  end
end
