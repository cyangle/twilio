...
module Twilio
  class ListMemberResponse
    ...
    @[JSON::Field(key: "queue_members", type: Array(Twilio::QueueMember)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter queue_members : Array(Twilio::QueueMember)? = nil
    ...
    def initialize(
      *,
      ...
      @queue_members : Array(Twilio::QueueMember)? = nil,
      @start : Int32? = nil,
      @uri : String? = nil
    )
    end
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_queue_members = @queue_members).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "queue_members", container: _queue_members)) if _queue_members.is_a?(Array)
      end
    ...
    def valid? : Bool
      ...
      unless (_queue_members = @queue_members).nil?
        return false if _queue_members.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _queue_members)
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] queue_members Object to be assigned
    def queue_members=(queue_members : Array(Twilio::QueueMember)?)
      if queue_members.nil?
        return @queue_members = nil
      end
      _queue_members = queue_members.not_nil!
      OpenApi::ContainerValidator.validate(container: _queue_members) if _queue_members.is_a?(Array)
      @queue_members = _queue_members
    end
    ...
    def_equals_and_hash(@_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @queue_members, @start, @uri)
  end
end
