...
module Twilio
  class ListMemberResponse
    ...
    @[JSON::Field(key: "queue_members", type: Array(QueueMember)?, presence: true, ignore_serialize: queue_members.nil? && !queue_members_present?, emit_null: true)]
    property queue_members : Array(QueueMember)?
    @[JSON::Field(ignore: true)]
    property? queue_members_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @queue_members : Array(QueueMember)? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [_end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, queue_members, start, uri].hash
    end
