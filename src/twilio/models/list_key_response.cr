...
module Twilio
  class ListKeyResponse
    ...
    @[JSON::Field(key: "keys", type: Array(Twilio::Key)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter keys : Array(Twilio::Key)? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_keys = @keys).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "keys", container: _keys)) if _keys.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_keys = @keys).nil?
        return false if _keys.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _keys)
      end
    ...
    def keys=(keys : Array(Twilio::Key)?)
      if keys.nil?
        return @keys = nil
      end
      _keys = keys.not_nil!
      OpenApi::ContainerValidator.validate(container: _keys) if _keys.is_a?(Array)
      @keys = _keys
    end
    ...
    def_equals_and_hash(@keys, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
