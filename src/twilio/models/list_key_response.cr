...
module Twilio
  class ListKeyResponse
    ...
    @[JSON::Field(key: "keys", type: Array(Key)?, presence: true, ignore_serialize: keys.nil? && !keys_present?, emit_null: true)]
    ...
    def hash
      [_end, first_page_uri, keys, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
