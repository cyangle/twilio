...
module Twilio
  ...
  class ListKeyResponse
    ...
    @[JSON::Field(key: "keys", type: Array(Key)?, presence: true, ignore_serialize: keys.nil? && !keys_present?)]
    property keys : Array(Key)?

    @[JSON::Field(ignore: true)]
    property? keys_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @keys : Array(Key)? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def_equals_and_hash(@_end, @first_page_uri, @keys, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
