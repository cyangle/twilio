...
module Twilio
  ...
  class ListSipIpAddressResponse
    ...
    @[JSON::Field(key: "ip_addresses", type: Array(SipSipIpAccessControlListSipIpAddress)?, presence: true, ignore_serialize: ip_addresses.nil? && !ip_addresses_present?)]
    ...
    def_equals_and_hash(@_end, @first_page_uri, @ip_addresses, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
