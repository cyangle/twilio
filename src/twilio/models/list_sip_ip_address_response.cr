...
module Twilio
  class ListSipIpAddressResponse
    ...
    @[JSON::Field(key: "ip_addresses", type: Array(SipSipIpAccessControlListSipIpAddress)?, presence: true, ignore_serialize: ip_addresses.nil? && !ip_addresses_present?, emit_null: true)]
    property ip_addresses : Array(SipSipIpAccessControlListSipIpAddress)?
    @[JSON::Field(ignore: true)]
    property? ip_addresses_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @ip_addresses : Array(SipSipIpAccessControlListSipIpAddress)? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [_end, first_page_uri, ip_addresses, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
