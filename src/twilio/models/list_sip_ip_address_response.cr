...
require "./sip_sip_ip_access_control_list_sip_ip_address"
...
module Twilio
  class ListSipIpAddressResponse
    ...
    def ip_addresses=(new_value : Array(Twilio::SipSipIpAccessControlListSipIpAddress)?)
      unless new_value.nil?
        OpenApi::ContainerValidator.validate(container: new_value) if new_value.is_a?(Array)
      end

      @ip_addresses = new_value
    end
