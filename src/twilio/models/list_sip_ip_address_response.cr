...
module Twilio
  class ListSipIpAddressResponse
    ...
    @[JSON::Field(key: "ip_addresses", type: Array(SipSipIpAccessControlListSipIpAddress)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter ip_addresses : Array(SipSipIpAccessControlListSipIpAddress)? = nil
    ...
    def ip_addresses=(ip_addresses : Array(SipSipIpAccessControlListSipIpAddress)?)
      if ip_addresses.nil?
