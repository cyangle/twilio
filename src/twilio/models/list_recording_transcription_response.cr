...
module Twilio
  class ListRecordingTranscriptionResponse
    ...
    @[JSON::Field(key: "transcriptions", type: Array(RecordingRecordingTranscription)?, presence: true, ignore_serialize: transcriptions.nil? && !transcriptions_present?, emit_null: true)]
    property transcriptions : Array(RecordingRecordingTranscription)?
    @[JSON::Field(ignore: true)]
    property? transcriptions_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @transcriptions : Array(RecordingRecordingTranscription)? = nil, @uri : String? = nil)
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        ...
        start == o.start &&
        transcriptions == o.transcriptions &&
        uri == o.uri
    end
    ...
    def hash
      [_end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, transcriptions, uri].hash
    end
