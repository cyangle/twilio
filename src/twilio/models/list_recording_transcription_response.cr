...
module Twilio
  class ListRecordingTranscriptionResponse
    ...
    @[JSON::Field(key: "transcriptions", type: Array(RecordingRecordingTranscription)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter transcriptions : Array(RecordingRecordingTranscription)? = nil
    ...
    def transcriptions=(transcriptions : Array(RecordingRecordingTranscription)?)
