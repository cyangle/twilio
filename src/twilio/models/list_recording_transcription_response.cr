...
module Twilio
  ...
  class ListRecordingTranscriptionResponse
    ...
    @[JSON::Field(key: "transcriptions", type: Array(RecordingRecordingTranscription)?, presence: true, ignore_serialize: transcriptions.nil? && !transcriptions_present?)]
    ...
    def_hash(@_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @transcriptions, @uri)
  end
end
