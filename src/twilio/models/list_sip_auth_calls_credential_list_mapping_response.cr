...
module Twilio
  class ListSipAuthCallsCredentialListMappingResponse
    ...
    # Optional properties
    @[JSON::Field(key: "contents", type: Array(SipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping)?, presence: true, ignore_serialize: contents.nil? && !contents_present?, emit_null: true)]
