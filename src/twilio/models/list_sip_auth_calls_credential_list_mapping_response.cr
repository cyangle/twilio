...
module Twilio
  ...
  class ListSipAuthCallsCredentialListMappingResponse
    ...
    # Optional properties
    @[JSON::Field(key: "contents", type: Array(SipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping)?, presence: true, ignore_serialize: contents.nil? && !contents_present?)]
    property contents : Array(SipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping)?
    ...
    def initialize(*, @contents : Array(SipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
