...
module Twilio
  class ListSipAuthCallsCredentialListMappingResponse
    ...
    @[JSON::Field(key: "contents", type: Array(SipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter contents : Array(SipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping)? = nil
    ...
    def contents=(contents : Array(SipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping)?)
      if contents.nil?
        return @contents = nil
      end
      @contents = contents
