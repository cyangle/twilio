...
module Twilio
  class CallCallFeedbackSummary
    ...
    @[NASON::Field(key: "issues", type: Array(Object)? | Null, nillable: true)]
    property issues : Array(Object)? | Null
    ...
    def initialize(*, @account_sid : String? | Null = nil, @call_count : Int32? | Null = nil, @call_feedback_count : Int32? | Null = nil, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @end_date : Time? | Null = nil, @include_subaccounts : Bool? | Null = nil, @issues : Array(Object)? | Null = nil, @quality_score_average : Float64? | Null = nil, @quality_score_median : Float64? | Null = nil, @quality_score_standard_deviation : Float64? | Null = nil, @sid : String? | Null = nil, @start_date : Time? | Null = nil, @status : String? | Null = nil)
    end
