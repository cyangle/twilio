...
module Twilio
  ...
  class UsageUsageRecordUsageRecordLastMonth
    ...
    def list_invalid_properties
      ...
      unless ENUM_VALIDATOR_FOR_CATEGORY.valid?(@category)
        invalid_properties.push("invalid value for \"category\", must be one of #{ENUM_VALIDATOR_FOR_CATEGORY.allowable_values}.")
      end
    ...
    def category=(category)
      unless ENUM_VALIDATOR_FOR_CATEGORY.valid?(category)
        raise ArgumentError.new("invalid value for \"category\", must be one of #{ENUM_VALIDATOR_FOR_CATEGORY.allowable_values}.")
      end
      @category = category
    end
