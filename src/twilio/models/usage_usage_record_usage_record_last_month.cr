...
module Twilio
  class UsageUsageRecordUsageRecordLastMonth
    ...
    @[JSON::Field(key: "category", type: Twilio::UsageRecordLastMonthEnumCategory?, default: nil, required: false, nullable: false, emit_null: false)]
    getter category : Twilio::UsageRecordLastMonthEnumCategory? = nil
    ...
    def category=(category : Twilio::UsageRecordLastMonthEnumCategory?)
      if category.nil?
        return @category = nil
      end
