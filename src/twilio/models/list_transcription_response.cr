...
module Twilio
  class ListTranscriptionResponse
    ...
    @[NASON::Field(key: "transcriptions", type: Array(Transcription)?, nillable: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @transcriptions : Array(Transcription)? = nil, @uri : String? = nil)
    end
