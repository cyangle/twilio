...
module Twilio
  class ListTranscriptionResponse
    ...
    @[JSON::Field(key: "transcriptions", type: Array(Transcription)?, presence: true, ignore_serialize: transcriptions.nil? && !transcriptions_present?, emit_null: true)]
    property transcriptions : Array(Transcription)?
    @[JSON::Field(ignore: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @transcriptions : Array(Transcription)? = nil, @uri : String? = nil)
    end
