...
module Twilio
  class ListTranscriptionResponse
    ...
    @[JSON::Field(key: "transcriptions", type: Array(Transcription)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter transcriptions : Array(Transcription)? = nil
    ...
    def transcriptions=(transcriptions : Array(Transcription)?)
