...
module Twilio
  class RecordingRecordingAddOnResult
    ...
    @[JSON::Field(key: "date_completed", type: Time?, converter: Time::RFC2822Converter, presence: true, ignore_serialize: date_completed.nil? && !date_completed_present?, emit_null: true)]
