...
module Twilio
  class RecordingRecordingAddOnResult
    ...
    @[NASON::Field(key: "date_completed", type: Time? | Null, converter: Time::RFC2822Converter, nillable: true)]
    property date_completed : Time? | Null
    ...
    def initialize(*, @account_sid : String? | Null = nil, @add_on_configuration_sid : String? | Null = nil, @add_on_sid : String? | Null = nil, @date_completed : Time? | Null = nil, @date_created : Time? | Null = nil, @date_updated : Time? | Null = nil, @reference_sid : String? | Null = nil, @sid : String? | Null = nil, @status : String? | Null = nil, @subresource_uris : Hash(String, String)? | Null = nil)
    end
    ...
    def valid?
      ...
      return false if !@sid.nil? && !@sid.null? && @sid.to_s.size < 34
      return false if !@sid.nil? && !@sid.null? && @sid !~ /^XR[0-9a-fA-F]{32}$/
