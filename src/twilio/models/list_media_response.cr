...
module Twilio
  class ListMediaResponse
    ...
    @[JSON::Field(key: "media_list", type: Array(Twilio::MessageMedia)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter media_list : Array(Twilio::MessageMedia)? = nil
    ...
    def initialize(
      *,
      ...
      @media_list : Array(Twilio::MessageMedia)? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_media_list = @media_list).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "media_list", container: _media_list)) if _media_list.is_a?(Array)
      end
    ...
    def valid? : Bool
      ...
      unless (_media_list = @media_list).nil?
        return false if _media_list.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _media_list)
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] media_list Object to be assigned
    def media_list=(media_list : Array(Twilio::MessageMedia)?)
      if media_list.nil?
        return @media_list = nil
      end
      _media_list = media_list.not_nil!
      OpenApi::ContainerValidator.validate(container: _media_list) if _media_list.is_a?(Array)
    ...
    def_equals_and_hash(@_end, @first_page_uri, @media_list, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
