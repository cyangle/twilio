...
module Twilio
  ...
  class ListMediaResponse
    ...
    @[JSON::Field(key: "media_list", type: Array(MessageMedia)?, presence: true, ignore_serialize: media_list.nil? && !media_list_present?)]
    ...
    def_hash(@_end, @first_page_uri, @media_list, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
