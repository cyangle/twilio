...
module Twilio
  class ListMediaResponse
    ...
    @[NASON::Field(key: "media_list", type: Array(MessageMedia)?, nillable: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @media_list : Array(MessageMedia)? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
