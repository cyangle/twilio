...
module Twilio
  class ListMediaResponse
    ...
    @[JSON::Field(key: "media_list", type: Array(MessageMedia)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter media_list : Array(MessageMedia)? = nil
    ...
    def media_list=(media_list : Array(MessageMedia)?)
      if media_list.nil?
