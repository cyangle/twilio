...
module Twilio
  class ListMediaResponse
    ...
    @[JSON::Field(key: "media_list", type: Array(MessageMedia)?, presence: true, ignore_serialize: media_list.nil? && !media_list_present?, emit_null: true)]
    property media_list : Array(MessageMedia)?
    @[JSON::Field(ignore: true)]
    property? media_list_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @media_list : Array(MessageMedia)? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [_end, first_page_uri, media_list, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
