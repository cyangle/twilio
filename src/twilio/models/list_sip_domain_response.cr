...
module Twilio
  class ListSipDomainResponse
    ...
    @[JSON::Field(key: "domains", type: Array(Twilio::SipSipDomain)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter domains : Array(Twilio::SipSipDomain)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @domains : Array(Twilio::SipSipDomain)? = nil,
      @_end : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_domains = @domains).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "domains", container: _domains)) if _domains.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_domains = @domains).nil?
        return false if _domains.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _domains)
      end
    ...
    # @param [Object] domains Object to be assigned
    def domains=(domains : Array(Twilio::SipSipDomain)?)
      if domains.nil?
        return @domains = nil
      end
      _domains = domains.not_nil!
      OpenApi::ContainerValidator.validate(container: _domains) if _domains.is_a?(Array)
      @domains = _domains
    end
    ...
    def_equals_and_hash(@domains, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
