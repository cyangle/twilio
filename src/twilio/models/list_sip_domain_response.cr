...
module Twilio
  class ListSipDomainResponse
    ...
    @[JSON::Field(key: "domains", type: Array(SipSipDomain)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter domains : Array(SipSipDomain)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @domains : Array(SipSipDomain)? = nil,
      @_end : Int32? = nil,
    ...
    def domains=(domains : Array(SipSipDomain)?)
      if domains.nil?
        return @domains = nil
      end
      @domains = domains
