...
module Twilio
  class ListSipDomainResponse
    ...
    # Optional properties
    @[NASON::Field(key: "domains", type: Array(SipSipDomain)?, nillable: true)]
    ...
    def initialize(*, @domains : Array(SipSipDomain)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [domains, _end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
