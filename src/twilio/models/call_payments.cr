...
module Twilio
  class CallPayments
    ...
    def initialize(*, @account_sid : String? | Null = nil, @call_sid : String? | Null = nil, @date_created : Time? | Null = nil, @date_updated : Time? | Null = nil, @sid : String? | Null = nil, @uri : String? | Null = nil)
    end
