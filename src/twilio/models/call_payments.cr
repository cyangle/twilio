...
module Twilio
  class CallPayments
    ...
    def initialize(*, @account_sid : String? | Null = nil, @call_sid : String? | Null = nil, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @sid : String? | Null = nil, @uri : String? | Null = nil)
    end
    ...
    def valid?
      ...
      return false if !@sid.nil? && !@sid.null? && @sid.to_s.size < 34
      return false if !@sid.nil? && !@sid.null? && @sid !~ /^PK[0-9a-fA-F]{32}$/
      true
    end
