...
module Twilio
  class ListSipAuthCallsIpAccessControlListMappingResponse
    ...
    # Optional properties
    @[JSON::Field(key: "contents", type: Array(SipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping)?, presence: true, ignore_serialize: contents.nil? && !contents_present?, emit_null: true)]
