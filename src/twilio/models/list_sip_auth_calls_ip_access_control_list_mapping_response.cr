...
module Twilio
  ...
  class ListSipAuthCallsIpAccessControlListMappingResponse
    ...
    # Optional properties
    @[JSON::Field(key: "contents", type: Array(SipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping)?, presence: true, ignore_serialize: contents.nil? && !contents_present?)]
    property contents : Array(SipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping)?
    ...
    def initialize(*, @contents : Array(SipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def_equals_and_hash(@contents, @_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
