...
module Twilio
  class ListSipAuthCallsIpAccessControlListMappingResponse
    ...
    @[JSON::Field(key: "contents", type: Array(SipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter contents : Array(SipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping)? = nil
    ...
    def contents=(contents : Array(SipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping)?)
      if contents.nil?
        return @contents = nil
      end
      @contents = contents
