...
require "./sip_sip_domain_sip_auth_sip_auth_calls_sip_auth_calls_ip_access_control_list_mapping"
...
module Twilio
  class ListSipAuthCallsIpAccessControlListMappingResponse
    ...
    @[JSON::Field(key: "contents", type: Array(Twilio::SipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter contents : Array(Twilio::SipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @contents : Array(Twilio::SipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping)? = nil,
      @_end : Int32? = nil,
    ...
    def contents=(new_value : Array(Twilio::SipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping)?)
