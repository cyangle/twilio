...
module Twilio
  class ListCallResponse
    ...
    # Optional properties
    @[NASON::Field(key: "calls", type: Array(Call)?, nillable: true)]
    ...
    def initialize(*, @calls : Array(Call)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
