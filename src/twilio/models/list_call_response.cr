...
module Twilio
  class ListCallResponse
    ...
    # Optional properties
    @[JSON::Field(key: "calls", type: Array(Call)?, presence: true, ignore_serialize: calls.nil? && !calls_present?, emit_null: true)]
    property calls : Array(Call)?
    @[JSON::Field(ignore: true)]
    property? calls_present : Bool = false
    ...
    def initialize(*, @calls : Array(Call)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [calls, _end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
