...
module Twilio
  ...
  class ListCallResponse
    ...
    # Optional properties
    @[JSON::Field(key: "calls", type: Array(Call)?, presence: true, ignore_serialize: calls.nil? && !calls_present?)]
    ...
    def_equals_and_hash(@calls, @_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
