...
module Twilio
  class SipSipIpAccessControlList
    ...
    def initialize(*, @account_sid : String? | Null = nil, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @friendly_name : String? | Null = nil, @sid : String? | Null = nil, @subresource_uris : SubresourceUris? | Null = nil, @uri : String? | Null = nil)
    end
