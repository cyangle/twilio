...
module Twilio
  class SipSipIpAccessControlList
    ...
    def_equals_and_hash(@sid, @sid_present, @account_sid, @account_sid_present, @friendly_name, @friendly_name_present, @date_created, @date_created_present, @date_updated, @date_updated_present, @subresource_uris, @subresource_uris_present, @uri, @uri_present)
  end
end
