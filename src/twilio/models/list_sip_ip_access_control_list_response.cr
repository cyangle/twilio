...
module Twilio
  class ListSipIpAccessControlListResponse
    ...
    @[NASON::Field(key: "ip_access_control_lists", type: Array(SipSipIpAccessControlList)?, nillable: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @ip_access_control_lists : Array(SipSipIpAccessControlList)? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
