...
module Twilio
  class ListSipIpAccessControlListResponse
    ...
    @[JSON::Field(key: "ip_access_control_lists", type: Array(Twilio::SipSipIpAccessControlList)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter ip_access_control_lists : Array(Twilio::SipSipIpAccessControlList)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @ip_access_control_lists : Array(Twilio::SipSipIpAccessControlList)? = nil,
      @_end : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_ip_access_control_lists = @ip_access_control_lists).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "ip_access_control_lists", container: _ip_access_control_lists)) if _ip_access_control_lists.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_ip_access_control_lists = @ip_access_control_lists).nil?
        return false if _ip_access_control_lists.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _ip_access_control_lists)
      end
    ...
    # @param [Object] ip_access_control_lists Object to be assigned
    def ip_access_control_lists=(ip_access_control_lists : Array(Twilio::SipSipIpAccessControlList)?)
      if ip_access_control_lists.nil?
        return @ip_access_control_lists = nil
      end
      _ip_access_control_lists = ip_access_control_lists.not_nil!
      OpenApi::ContainerValidator.validate(container: _ip_access_control_lists) if _ip_access_control_lists.is_a?(Array)
      @ip_access_control_lists = _ip_access_control_lists
    end
    ...
    def_equals_and_hash(@ip_access_control_lists, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
