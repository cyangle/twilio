...
module Twilio
  class ListSipIpAccessControlListResponse
    ...
    @[JSON::Field(key: "ip_access_control_lists", type: Array(SipSipIpAccessControlList)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter ip_access_control_lists : Array(SipSipIpAccessControlList)? = nil
    ...
    def ip_access_control_lists=(ip_access_control_lists : Array(SipSipIpAccessControlList)?)
