...
module Twilio
  class ListSipIpAccessControlListResponse
    ...
    @[JSON::Field(key: "ip_access_control_lists", type: Array(SipSipIpAccessControlList)?, presence: true, ignore_serialize: ip_access_control_lists.nil? && !ip_access_control_lists_present?, emit_null: true)]
    property ip_access_control_lists : Array(SipSipIpAccessControlList)?
    @[JSON::Field(ignore: true)]
    property? ip_access_control_lists_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @ip_access_control_lists : Array(SipSipIpAccessControlList)? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        ...
        ip_access_control_lists == o.ip_access_control_lists &&
    ...
    def hash
      [_end, first_page_uri, ip_access_control_lists, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
