...
module Twilio
  ...
  class ListSipIpAccessControlListResponse
    ...
    @[JSON::Field(key: "ip_access_control_lists", type: Array(SipSipIpAccessControlList)?, presence: true, ignore_serialize: ip_access_control_lists.nil? && !ip_access_control_lists_present?)]
    ...
    def_hash(@_end, @first_page_uri, @ip_access_control_lists, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
