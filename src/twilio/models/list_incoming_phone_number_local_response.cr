...
require "./incoming_phone_number_incoming_phone_number_local"
...
module Twilio
  class ListIncomingPhoneNumberLocalResponse
    ...
    def incoming_phone_numbers=(new_value : Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberLocal)?)
      unless new_value.nil?
        OpenApi::ContainerValidator.validate(container: new_value) if new_value.is_a?(Array)
      end

      @incoming_phone_numbers = new_value
    end
