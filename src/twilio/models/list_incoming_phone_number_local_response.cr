...
module Twilio
  class ListIncomingPhoneNumberLocalResponse
    ...
    @[JSON::Field(key: "incoming_phone_numbers", type: Array(IncomingPhoneNumberIncomingPhoneNumberLocal)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter incoming_phone_numbers : Array(IncomingPhoneNumberIncomingPhoneNumberLocal)? = nil
    ...
    def initialize(
      *,
      ...
      @incoming_phone_numbers : Array(IncomingPhoneNumberIncomingPhoneNumberLocal)? = nil,
    ...
    def incoming_phone_numbers=(incoming_phone_numbers : Array(IncomingPhoneNumberIncomingPhoneNumberLocal)?)
