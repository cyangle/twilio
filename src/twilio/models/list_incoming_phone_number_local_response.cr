...
module Twilio
  ...
  class ListIncomingPhoneNumberLocalResponse
    ...
    @[JSON::Field(key: "incoming_phone_numbers", type: Array(IncomingPhoneNumberIncomingPhoneNumberLocal)?, presence: true, ignore_serialize: incoming_phone_numbers.nil? && !incoming_phone_numbers_present?)]
    ...
    def_hash(@_end, @first_page_uri, @incoming_phone_numbers, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
