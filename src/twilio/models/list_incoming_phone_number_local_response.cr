...
module Twilio
  class ListIncomingPhoneNumberLocalResponse
    ...
    @[JSON::Field(key: "incoming_phone_numbers", type: Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberLocal)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter incoming_phone_numbers : Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberLocal)? = nil
    ...
    def initialize(
      *,
      ...
      @incoming_phone_numbers : Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberLocal)? = nil,
    ...
    def incoming_phone_numbers=(incoming_phone_numbers : Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberLocal)?)
    ...
    def_equals_and_hash(@_end, @first_page_uri, @incoming_phone_numbers, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
