...
module Twilio
  class Balance
    ...
    # Account balance
    @[NASON::Field(key: "balance", type: String? | Null, nillable: true)]
    property balance : String? | Null
    ...
    def initialize(*, @account_sid : String? | Null = nil, @balance : String? | Null = nil, @currency : String? | Null = nil)
    end
    ...
    def hash
      [account_sid, balance, currency].hash
    end
