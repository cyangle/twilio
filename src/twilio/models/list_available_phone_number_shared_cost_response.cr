...
module Twilio
  class ListAvailablePhoneNumberSharedCostResponse
    ...
    @[JSON::Field(key: "available_phone_numbers", type: Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberSharedCost)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter available_phone_numbers : Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberSharedCost)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @available_phone_numbers : Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberSharedCost)? = nil,
      @_end : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_available_phone_numbers = @available_phone_numbers).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "available_phone_numbers", container: _available_phone_numbers)) if _available_phone_numbers.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_available_phone_numbers = @available_phone_numbers).nil?
        return false if _available_phone_numbers.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _available_phone_numbers)
      end
    ...
    def available_phone_numbers=(available_phone_numbers : Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberSharedCost)?)
      if available_phone_numbers.nil?
        return @available_phone_numbers = nil
      end
      _available_phone_numbers = available_phone_numbers.not_nil!
      OpenApi::ContainerValidator.validate(container: _available_phone_numbers) if _available_phone_numbers.is_a?(Array)
      @available_phone_numbers = _available_phone_numbers
    end
    ...
    def_equals_and_hash(@available_phone_numbers, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
