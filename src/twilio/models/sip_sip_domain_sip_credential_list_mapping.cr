...
module Twilio
  class SipSipDomainSipCredentialListMapping
    ...
    def domain_sid=(domain_sid : String?)
      if domain_sid.nil?
        return @domain_sid = nil
      end
      _domain_sid = domain_sid.not_nil!
      OpenApi::PrimitiveValidator.validate_max_length("domain_sid", _domain_sid.to_s.size, MAX_LENGTH_FOR_DOMAIN_SID)
      OpenApi::PrimitiveValidator.validate_min_length("domain_sid", _domain_sid.to_s.size, MIN_LENGTH_FOR_DOMAIN_SID)
      OpenApi::PrimitiveValidator.validate_pattern("domain_sid", _domain_sid, PATTERN_FOR_DOMAIN_SID)
