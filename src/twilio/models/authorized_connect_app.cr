...
module Twilio
  class AuthorizedConnectApp
    ...
    @[JSON::Field(key: "connect_app_company_name", type: String?, presence: true, ignore_serialize: connect_app_company_name.nil? && !connect_app_company_name_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "connect_app_description", type: String?, presence: true, ignore_serialize: connect_app_description.nil? && !connect_app_description_present?, emit_null: true)]
    property connect_app_description : String?
    @[JSON::Field(ignore: true)]
    property? connect_app_description_present : Bool = false

    # The name of the Connect App
    @[JSON::Field(key: "connect_app_friendly_name", type: String?, presence: true, ignore_serialize: connect_app_friendly_name.nil? && !connect_app_friendly_name_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "connect_app_homepage_url", type: String?, presence: true, ignore_serialize: connect_app_homepage_url.nil? && !connect_app_homepage_url_present?, emit_null: true)]
    property connect_app_homepage_url : String?
    @[JSON::Field(ignore: true)]
    property? connect_app_homepage_url_present : Bool = false

    # The SID that we assigned to the Connect App
    @[JSON::Field(key: "connect_app_sid", type: String?, presence: true, ignore_serialize: connect_app_sid.nil? && !connect_app_sid_present?, emit_null: true)]
