...
module Twilio
  class AuthorizedConnectApp
    ...
    @[NASON::Field(key: "connect_app_company_name", type: String? | Null, nillable: true)]
    property connect_app_company_name : String? | Null

    # A detailed description of the app
    @[NASON::Field(key: "connect_app_description", type: String? | Null, nillable: true)]
    property connect_app_description : String? | Null

    # The name of the Connect App
    @[NASON::Field(key: "connect_app_friendly_name", type: String? | Null, nillable: true)]
    property connect_app_friendly_name : String? | Null

    # The public URL for the Connect App
    @[NASON::Field(key: "connect_app_homepage_url", type: String? | Null, nillable: true)]
    property connect_app_homepage_url : String? | Null

    # The SID that we assigned to the Connect App
    @[NASON::Field(key: "connect_app_sid", type: String? | Null, nillable: true)]
    property connect_app_sid : String? | Null
    ...
    def initialize(*, @account_sid : String? | Null = nil, @connect_app_company_name : String? | Null = nil, @connect_app_description : String? | Null = nil, @connect_app_friendly_name : String? | Null = nil, @connect_app_homepage_url : String? | Null = nil, @connect_app_sid : String? | Null = nil, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @permissions : Array(String)? | Null = nil, @uri : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@connect_app_sid.nil? && !@connect_app_sid.null? && @connect_app_sid.to_s.size > 34
      ...
      if !@connect_app_sid.nil? && !@connect_app_sid.null? && @connect_app_sid !~ pattern
    ...
    def valid?
      ...
      return false if !@connect_app_sid.nil? && !@connect_app_sid.null? && @connect_app_sid.to_s.size > 34
      return false if !@connect_app_sid.nil? && !@connect_app_sid.null? && @connect_app_sid.to_s.size < 34
      return false if !@connect_app_sid.nil? && !@connect_app_sid.null? && @connect_app_sid !~ /^CN[0-9a-fA-F]{32}$/
      true
    end
