...
module Twilio
  class ListAvailablePhoneNumberMachineToMachineResponse
    ...
    # Optional properties
    @[NASON::Field(key: "available_phone_numbers", type: Array(AvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine)?, nillable: true)]
    ...
    def initialize(*, @available_phone_numbers : Array(AvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
