...
module Twilio
  class ListAvailablePhoneNumberMachineToMachineResponse
    ...
    @[JSON::Field(key: "available_phone_numbers", type: Array(AvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter available_phone_numbers : Array(AvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine)? = nil
    ...
    def available_phone_numbers=(available_phone_numbers : Array(AvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine)?)
