...
module Twilio
  ...
  class ListAvailablePhoneNumberMachineToMachineResponse
    ...
    # Optional properties
    @[JSON::Field(key: "available_phone_numbers", type: Array(AvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine)?, presence: true, ignore_serialize: available_phone_numbers.nil? && !available_phone_numbers_present?)]
    property available_phone_numbers : Array(AvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine)?
    ...
    def initialize(*, @available_phone_numbers : Array(AvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def_equals_and_hash(@available_phone_numbers, @_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
