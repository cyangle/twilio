...
module Twilio
  class ListAvailablePhoneNumberMobileResponse
    ...
    @[JSON::Field(key: "available_phone_numbers", type: Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberMobile)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter available_phone_numbers : Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberMobile)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @available_phone_numbers : Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberMobile)? = nil,
      @_end : Int32? = nil,
    ...
    def available_phone_numbers=(available_phone_numbers : Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberMobile)?)
