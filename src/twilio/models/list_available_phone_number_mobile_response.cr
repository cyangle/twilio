...
module Twilio
  class ListAvailablePhoneNumberMobileResponse
    ...
    @[JSON::Field(key: "available_phone_numbers", type: Array(AvailablePhoneNumberCountryAvailablePhoneNumberMobile)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter available_phone_numbers : Array(AvailablePhoneNumberCountryAvailablePhoneNumberMobile)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @available_phone_numbers : Array(AvailablePhoneNumberCountryAvailablePhoneNumberMobile)? = nil,
      @_end : Int32? = nil,
    ...
    def available_phone_numbers=(available_phone_numbers : Array(AvailablePhoneNumberCountryAvailablePhoneNumberMobile)?)
