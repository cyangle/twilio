...
module Twilio
  class ListAvailablePhoneNumberLocalResponse
    ...
    @[JSON::Field(key: "available_phone_numbers", type: Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberLocal)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter available_phone_numbers : Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberLocal)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @available_phone_numbers : Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberLocal)? = nil,
      @_end : Int32? = nil,
    ...
    def available_phone_numbers=(available_phone_numbers : Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberLocal)?)
