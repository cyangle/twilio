...
module Twilio
  class ListAvailablePhoneNumberLocalResponse
    ...
    @[JSON::Field(key: "available_phone_numbers", type: Array(AvailablePhoneNumberCountryAvailablePhoneNumberLocal)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter available_phone_numbers : Array(AvailablePhoneNumberCountryAvailablePhoneNumberLocal)? = nil
    ...
    def available_phone_numbers=(available_phone_numbers : Array(AvailablePhoneNumberCountryAvailablePhoneNumberLocal)?)
