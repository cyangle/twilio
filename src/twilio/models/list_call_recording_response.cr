...
module Twilio
  class ListCallRecordingResponse
    ...
    @[JSON::Field(key: "recordings", type: Array(Twilio::CallCallRecording)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter recordings : Array(Twilio::CallCallRecording)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @recordings : Array(Twilio::CallCallRecording)? = nil,
      @_end : Int32? = nil,
    ...
    def recordings=(recordings : Array(Twilio::CallCallRecording)?)
      if recordings.nil?
