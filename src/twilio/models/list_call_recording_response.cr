...
module Twilio
  class ListCallRecordingResponse
    ...
    @[JSON::Field(key: "recordings", type: Array(CallCallRecording)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter recordings : Array(CallCallRecording)? = nil
    ...
    def recordings=(recordings : Array(CallCallRecording)?)
      if recordings.nil?
