...
module Twilio
  class ListCallRecordingResponse
    ...
    @[JSON::Field(key: "recordings", type: Array(CallCallRecording)?, presence: true, ignore_serialize: recordings.nil? && !recordings_present?, emit_null: true)]
    property recordings : Array(CallCallRecording)?
    @[JSON::Field(ignore: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @recordings : Array(CallCallRecording)? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
