...
module Twilio
  class ValidationRequest
    ...
    @[NASON::Field(key: "validation_code", type: String? | Null, nillable: true)]
    property validation_code : String? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @account_sid : String? | Null = nil, @call_sid : String? | Null = nil, @friendly_name : String? | Null = nil, @phone_number : String? | Null = nil, @validation_code : String? | Null = nil)
    end
