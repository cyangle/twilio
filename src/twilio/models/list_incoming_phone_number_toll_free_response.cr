...
module Twilio
  class ListIncomingPhoneNumberTollFreeResponse
    ...
    @[JSON::Field(key: "incoming_phone_numbers", type: Array(IncomingPhoneNumberIncomingPhoneNumberTollFree)?, presence: true, ignore_serialize: incoming_phone_numbers.nil? && !incoming_phone_numbers_present?, emit_null: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @incoming_phone_numbers : Array(IncomingPhoneNumberIncomingPhoneNumberTollFree)? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
