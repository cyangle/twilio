...
module Twilio
  class ListIncomingPhoneNumberTollFreeResponse
    ...
    @[NASON::Field(key: "incoming_phone_numbers", type: Array(IncomingPhoneNumberIncomingPhoneNumberTollFree)?, nillable: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @incoming_phone_numbers : Array(IncomingPhoneNumberIncomingPhoneNumberTollFree)? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
