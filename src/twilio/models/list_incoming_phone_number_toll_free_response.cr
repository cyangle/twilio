...
module Twilio
  class ListIncomingPhoneNumberTollFreeResponse
    ...
    @[JSON::Field(key: "incoming_phone_numbers", type: Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberTollFree)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter incoming_phone_numbers : Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberTollFree)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @incoming_phone_numbers : Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberTollFree)? = nil,
      @_end : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_incoming_phone_numbers = @incoming_phone_numbers).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "incoming_phone_numbers", container: _incoming_phone_numbers)) if _incoming_phone_numbers.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_incoming_phone_numbers = @incoming_phone_numbers).nil?
        return false if _incoming_phone_numbers.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _incoming_phone_numbers)
      end
    ...
    # @param [Object] incoming_phone_numbers Object to be assigned
    def incoming_phone_numbers=(incoming_phone_numbers : Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberTollFree)?)
      if incoming_phone_numbers.nil?
        return @incoming_phone_numbers = nil
      end
      _incoming_phone_numbers = incoming_phone_numbers.not_nil!
      OpenApi::ContainerValidator.validate(container: _incoming_phone_numbers) if _incoming_phone_numbers.is_a?(Array)
      @incoming_phone_numbers = _incoming_phone_numbers
    end
    ...
    def_equals_and_hash(@incoming_phone_numbers, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
