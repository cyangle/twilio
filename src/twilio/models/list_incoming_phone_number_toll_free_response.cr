...
module Twilio
  class ListIncomingPhoneNumberTollFreeResponse
    ...
    @[JSON::Field(key: "incoming_phone_numbers", type: Array(IncomingPhoneNumberIncomingPhoneNumberTollFree)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter incoming_phone_numbers : Array(IncomingPhoneNumberIncomingPhoneNumberTollFree)? = nil
    ...
    def incoming_phone_numbers=(incoming_phone_numbers : Array(IncomingPhoneNumberIncomingPhoneNumberTollFree)?)
