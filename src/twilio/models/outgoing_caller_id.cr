...
module Twilio
  ...
  class OutgoingCallerId
    ...
    def initialize(*, @account_sid : String? = nil, @date_created : Time? = nil, @date_updated : Time? = nil, @friendly_name : String? = nil, @phone_number : String? = nil, @sid : String? = nil, @uri : String? = nil)
    end
    ...
    def_equals_and_hash(@account_sid, @date_created, @date_updated, @friendly_name, @phone_number, @sid, @uri)
  end
end
