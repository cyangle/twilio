...
module Twilio
  class OutgoingCallerId
    ...
    def initialize(*, @account_sid : String? | Null = nil, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @friendly_name : String? | Null = nil, @phone_number : String? | Null = nil, @sid : String? | Null = nil, @uri : String? | Null = nil)
    end
    ...
    def hash
      [account_sid, date_created, date_updated, friendly_name, phone_number, sid, uri].hash
    end
