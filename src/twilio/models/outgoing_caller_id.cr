...
module Twilio
  class OutgoingCallerId
    ...
    def initialize(*, @account_sid : String? | Null = nil, @date_created : Time? | Null = nil, @date_updated : Time? | Null = nil, @friendly_name : String? | Null = nil, @phone_number : String? | Null = nil, @sid : String? | Null = nil, @uri : String? | Null = nil)
    end
