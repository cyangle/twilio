...
module Twilio
  class CallSiprec
    ...
    def initialize(*, @account_sid : String? | Null = nil, @call_sid : String? | Null = nil, @date_updated : String? | Null = nil, @name : String? | Null = nil, @sid : String? | Null = nil, @status : String? | Null = nil)
    end
