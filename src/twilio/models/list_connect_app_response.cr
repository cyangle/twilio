...
module Twilio
  class ListConnectAppResponse
    ...
    @[JSON::Field(key: "connect_apps", type: Array(Twilio::ConnectApp)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter connect_apps : Array(Twilio::ConnectApp)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @connect_apps : Array(Twilio::ConnectApp)? = nil,
      @_end : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_connect_apps = @connect_apps).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "connect_apps", container: _connect_apps)) if _connect_apps.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_connect_apps = @connect_apps).nil?
        return false if _connect_apps.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _connect_apps)
      end
    ...
    # @param [Object] connect_apps Object to be assigned
    def connect_apps=(connect_apps : Array(Twilio::ConnectApp)?)
      if connect_apps.nil?
        return @connect_apps = nil
      end
      _connect_apps = connect_apps.not_nil!
      OpenApi::ContainerValidator.validate(container: _connect_apps) if _connect_apps.is_a?(Array)
      @connect_apps = _connect_apps
    end
    ...
    def_equals_and_hash(@connect_apps, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
