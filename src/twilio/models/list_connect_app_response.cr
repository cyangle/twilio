...
module Twilio
  ...
  class ListConnectAppResponse
    ...
    # Optional properties
    @[JSON::Field(key: "connect_apps", type: Array(ConnectApp)?, presence: true, ignore_serialize: connect_apps.nil? && !connect_apps_present?)]
    ...
    def_hash(@connect_apps, @_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
