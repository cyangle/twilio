...
module Twilio
  class ListConnectAppResponse
    ...
    # Optional properties
    @[JSON::Field(key: "connect_apps", type: Array(ConnectApp)?, presence: true, ignore_serialize: connect_apps.nil? && !connect_apps_present?, emit_null: true)]
    property connect_apps : Array(ConnectApp)?
    @[JSON::Field(ignore: true)]
    property? connect_apps_present : Bool = false
    ...
    def initialize(*, @connect_apps : Array(ConnectApp)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [connect_apps, _end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
