...
module Twilio
  class ListConnectAppResponse
    ...
    @[JSON::Field(key: "connect_apps", type: Array(ConnectApp)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter connect_apps : Array(ConnectApp)? = nil
    ...
    def connect_apps=(connect_apps : Array(ConnectApp)?)
      if connect_apps.nil?
