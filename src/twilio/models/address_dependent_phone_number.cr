...
module Twilio
  class AddressDependentPhoneNumber
    ...
    @[JSON::Field(key: "capabilities", type: AddressDependentPhoneNumberCapabilities?, presence: true, ignore_serialize: capabilities.nil? && !capabilities_present?, emit_null: true)]
