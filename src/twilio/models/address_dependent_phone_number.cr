...
module Twilio
  class AddressDependentPhoneNumber
    ...
    @[JSON::Field(key: "capabilities", type: AddressDependentPhoneNumberCapabilities?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: capabilities.nil? && !capabilities_present?)]
    getter capabilities : AddressDependentPhoneNumberCapabilities? = nil
    ...
    def capabilities=(capabilities : AddressDependentPhoneNumberCapabilities?)
      if capabilities.nil?
