...
module Twilio
  class AddressDependentPhoneNumber
    ...
    def initialize(*, @account_sid : String? | Null = nil, @address_requirements : String? | Null = nil, @api_version : String? | Null = nil, @capabilities : AddressDependentPhoneNumberCapabilities? | Null = nil, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @emergency_address_sid : String? | Null = nil, @emergency_status : String? | Null = nil, @friendly_name : String? | Null = nil, @phone_number : String? | Null = nil, @sid : String? | Null = nil, @sms_application_sid : String? | Null = nil, @sms_fallback_method : String? | Null = nil, @sms_fallback_url : String? | Null = nil, @sms_method : String? | Null = nil, @sms_url : String? | Null = nil, @status_callback : String? | Null = nil, @status_callback_method : String? | Null = nil, @trunk_sid : String? | Null = nil, @uri : String? | Null = nil, @voice_application_sid : String? | Null = nil, @voice_caller_id_lookup : Bool? | Null = nil, @voice_fallback_method : String? | Null = nil, @voice_fallback_url : String? | Null = nil, @voice_method : String? | Null = nil, @voice_url : String? | Null = nil)
    end
