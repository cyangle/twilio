...
module Twilio
  ...
  class ListSipCredentialListMappingResponse
    ...
    # Optional properties
    @[JSON::Field(key: "credential_list_mappings", type: Array(SipSipDomainSipCredentialListMapping)?, presence: true, ignore_serialize: credential_list_mappings.nil? && !credential_list_mappings_present?)]
    property credential_list_mappings : Array(SipSipDomainSipCredentialListMapping)?

    @[JSON::Field(ignore: true)]
    property? credential_list_mappings_present : Bool = false
    ...
    def initialize(*, @credential_list_mappings : Array(SipSipDomainSipCredentialListMapping)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def_equals_and_hash(@credential_list_mappings, @_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
