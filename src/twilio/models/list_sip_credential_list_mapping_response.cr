...
require "./sip_sip_domain_sip_credential_list_mapping"
...
module Twilio
  class ListSipCredentialListMappingResponse
    ...
    def credential_list_mappings=(new_value : Array(Twilio::SipSipDomainSipCredentialListMapping)?)
      unless new_value.nil?
        OpenApi::ContainerValidator.validate(container: new_value) if new_value.is_a?(Array)
      end

      @credential_list_mappings = new_value
    end
