...
module Twilio
  class ListSipCredentialListMappingResponse
    ...
    @[JSON::Field(key: "credential_list_mappings", type: Array(SipSipDomainSipCredentialListMapping)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter credential_list_mappings : Array(SipSipDomainSipCredentialListMapping)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @credential_list_mappings : Array(SipSipDomainSipCredentialListMapping)? = nil,
      @_end : Int32? = nil,
    ...
    def credential_list_mappings=(credential_list_mappings : Array(SipSipDomainSipCredentialListMapping)?)
