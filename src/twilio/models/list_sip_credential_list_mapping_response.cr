...
module Twilio
  class ListSipCredentialListMappingResponse
    ...
    # Optional properties
    @[JSON::Field(key: "credential_list_mappings", type: Array(SipSipDomainSipCredentialListMapping)?, presence: true, ignore_serialize: credential_list_mappings.nil? && !credential_list_mappings_present?, emit_null: true)]
