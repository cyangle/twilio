...
module Twilio
  class ListSipCredentialListMappingResponse
    ...
    @[JSON::Field(key: "credential_list_mappings", type: Array(Twilio::SipSipDomainSipCredentialListMapping)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter credential_list_mappings : Array(Twilio::SipSipDomainSipCredentialListMapping)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @credential_list_mappings : Array(Twilio::SipSipDomainSipCredentialListMapping)? = nil,
      @_end : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_credential_list_mappings = @credential_list_mappings).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "credential_list_mappings", container: _credential_list_mappings)) if _credential_list_mappings.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_credential_list_mappings = @credential_list_mappings).nil?
        return false if _credential_list_mappings.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _credential_list_mappings)
      end
    ...
    # @param [Object] credential_list_mappings Object to be assigned
    def credential_list_mappings=(credential_list_mappings : Array(Twilio::SipSipDomainSipCredentialListMapping)?)
      if credential_list_mappings.nil?
        return @credential_list_mappings = nil
      end
      _credential_list_mappings = credential_list_mappings.not_nil!
      OpenApi::ContainerValidator.validate(container: _credential_list_mappings) if _credential_list_mappings.is_a?(Array)
      @credential_list_mappings = _credential_list_mappings
    end
    ...
    def_equals_and_hash(@credential_list_mappings, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
