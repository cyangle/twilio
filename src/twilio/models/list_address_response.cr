...
module Twilio
  class ListAddressResponse
    ...
    @[JSON::Field(key: "addresses", type: Array(Twilio::Address)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter addresses : Array(Twilio::Address)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @addresses : Array(Twilio::Address)? = nil,
      @_end : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_addresses = @addresses).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "addresses", container: _addresses)) if _addresses.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_addresses = @addresses).nil?
        return false if _addresses.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _addresses)
      end
    ...
    def addresses=(addresses : Array(Twilio::Address)?)
      if addresses.nil?
        return @addresses = nil
      end
      _addresses = addresses.not_nil!
      OpenApi::ContainerValidator.validate(container: _addresses) if _addresses.is_a?(Array)
    ...
    def_equals_and_hash(@addresses, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
