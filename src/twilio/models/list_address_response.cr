...
module Twilio
  class ListAddressResponse
    ...
    # Optional properties
    @[JSON::Field(key: "addresses", type: Array(Address)?, presence: true, ignore_serialize: addresses.nil? && !addresses_present?, emit_null: true)]
    property addresses : Array(Address)?
    @[JSON::Field(ignore: true)]
    property? addresses_present : Bool = false
    ...
    def initialize(*, @addresses : Array(Address)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [addresses, _end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
