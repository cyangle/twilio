...
module Twilio
  ...
  class ListAddressResponse
    ...
    # Optional properties
    @[JSON::Field(key: "addresses", type: Array(Address)?, presence: true, ignore_serialize: addresses.nil? && !addresses_present?)]
    ...
    def_equals_and_hash(@addresses, @_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
