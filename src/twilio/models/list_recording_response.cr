...
module Twilio
  class ListRecordingResponse
    ...
    @[JSON::Field(key: "recordings", type: Array(Recording)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter recordings : Array(Recording)? = nil
    ...
    def recordings=(recordings : Array(Recording)?)
      if recordings.nil?
