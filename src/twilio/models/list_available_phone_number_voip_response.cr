...
require "./available_phone_number_country_available_phone_number_voip"
...
module Twilio
  class ListAvailablePhoneNumberVoipResponse
    ...
    def available_phone_numbers=(new_value : Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberVoip)?)
      unless new_value.nil?
        OpenApi::ContainerValidator.validate(container: new_value) if new_value.is_a?(Array)
      end

      @available_phone_numbers = new_value
    end
