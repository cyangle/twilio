...
module Twilio
  class AvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine
    ...
    @[NASON::Field(key: "latitude", type: String? | Null, nillable: true)]
    property latitude : String? | Null
    ...
    @[NASON::Field(key: "longitude", type: String? | Null, nillable: true)]
    property longitude : String? | Null
    ...
    def initialize(*, @address_requirements : String? | Null = nil, @beta : Bool? | Null = nil, @capabilities : AvailablePhoneNumberCountryAvailablePhoneNumberLocalCapabilities? | Null = nil, @friendly_name : String? | Null = nil, @iso_country : String? | Null = nil, @lata : String? | Null = nil, @latitude : String? | Null = nil, @locality : String? | Null = nil, @longitude : String? | Null = nil, @phone_number : String? | Null = nil, @postal_code : String? | Null = nil, @rate_center : String? | Null = nil, @region : String? | Null = nil)
    end
