...
module Twilio
  class CallCallFeedback
    ...
    @[NASON::Field(key: "quality_score", type: Int32? | Null, nillable: true)]
    property quality_score : Int32? | Null
    ...
    def initialize(*, @account_sid : String? | Null = nil, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @issues : Array(String)? | Null = nil, @quality_score : Int32? | Null = nil, @sid : String? | Null = nil)
    end
