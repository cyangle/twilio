...
require "./call_feedback_enum_issues"
...
module Twilio
  class CallCallFeedback
    ...
    @[JSON::Field(key: "issues", type: Array(CallFeedbackEnumIssues)?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: issues.nil? && !issues_present?)]
    getter issues : Array(CallFeedbackEnumIssues)? = nil
    ...
    def initialize(
      *,
      ...
      @issues : Array(CallFeedbackEnumIssues)? = nil,
    ...
    def issues=(new_value : Array(CallFeedbackEnumIssues)?)
      @issues = new_value
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] quality_score Object to be assigned
    def quality_score=(new_value : Int32?)
      @quality_score = new_value
    end
