...
module Twilio
  ...
  class ListOutgoingCallerIdResponse
    ...
    @[JSON::Field(key: "outgoing_caller_ids", type: Array(OutgoingCallerId)?, presence: true, ignore_serialize: outgoing_caller_ids.nil? && !outgoing_caller_ids_present?)]
    ...
    def_hash(@_end, @first_page_uri, @next_page_uri, @outgoing_caller_ids, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
