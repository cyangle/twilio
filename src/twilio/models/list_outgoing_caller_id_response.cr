...
module Twilio
  class ListOutgoingCallerIdResponse
    ...
    @[JSON::Field(key: "outgoing_caller_ids", type: Array(OutgoingCallerId)?, presence: true, ignore_serialize: outgoing_caller_ids.nil? && !outgoing_caller_ids_present?, emit_null: true)]
    property outgoing_caller_ids : Array(OutgoingCallerId)?
    @[JSON::Field(ignore: true)]
    property? outgoing_caller_ids_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @outgoing_caller_ids : Array(OutgoingCallerId)? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        ...
        outgoing_caller_ids == o.outgoing_caller_ids &&
        page == o.page &&
    ...
    def hash
      [_end, first_page_uri, next_page_uri, outgoing_caller_ids, page, page_size, previous_page_uri, start, uri].hash
    end
