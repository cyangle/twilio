...
module Twilio
  class ListOutgoingCallerIdResponse
    ...
    @[NASON::Field(key: "outgoing_caller_ids", type: Array(OutgoingCallerId)?, nillable: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @outgoing_caller_ids : Array(OutgoingCallerId)? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
