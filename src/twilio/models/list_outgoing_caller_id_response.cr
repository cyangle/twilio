...
module Twilio
  class ListOutgoingCallerIdResponse
    ...
    @[JSON::Field(key: "outgoing_caller_ids", type: Array(OutgoingCallerId)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter outgoing_caller_ids : Array(OutgoingCallerId)? = nil
    ...
    def outgoing_caller_ids=(outgoing_caller_ids : Array(OutgoingCallerId)?)
