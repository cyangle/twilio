...
module Twilio
  class ListIncomingPhoneNumberAssignedAddOnExtensionResponse
    ...
    @[JSON::Field(key: "extensions", type: Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOnIncomingPhoneNumberAssignedAddOnExtension)?, presence: true, ignore_serialize: extensions.nil? && !extensions_present?, emit_null: true)]
    ...
    def hash
      [_end, extensions, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
