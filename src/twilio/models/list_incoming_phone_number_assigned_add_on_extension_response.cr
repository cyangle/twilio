...
module Twilio
  class ListIncomingPhoneNumberAssignedAddOnExtensionResponse
    ...
    @[NASON::Field(key: "extensions", type: Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOnIncomingPhoneNumberAssignedAddOnExtension)?, nillable: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @extensions : Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOnIncomingPhoneNumberAssignedAddOnExtension)? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
