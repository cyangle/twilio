...
module Twilio
  ...
  class ListIncomingPhoneNumberAssignedAddOnExtensionResponse
    ...
    @[JSON::Field(key: "extensions", type: Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOnIncomingPhoneNumberAssignedAddOnExtension)?, presence: true, ignore_serialize: extensions.nil? && !extensions_present?)]
    property extensions : Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOnIncomingPhoneNumberAssignedAddOnExtension)?

    @[JSON::Field(ignore: true)]
    property? extensions_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @extensions : Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOnIncomingPhoneNumberAssignedAddOnExtension)? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def_equals_and_hash(@_end, @extensions, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
