...
module Twilio
  class ListIncomingPhoneNumberAssignedAddOnExtensionResponse
    ...
    @[JSON::Field(key: "extensions", type: Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOnIncomingPhoneNumberAssignedAddOnExtension)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter extensions : Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOnIncomingPhoneNumberAssignedAddOnExtension)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @_end : Int32? = nil,
      @extensions : Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOnIncomingPhoneNumberAssignedAddOnExtension)? = nil,
    ...
    def extensions=(extensions : Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOnIncomingPhoneNumberAssignedAddOnExtension)?)
      if extensions.nil?
