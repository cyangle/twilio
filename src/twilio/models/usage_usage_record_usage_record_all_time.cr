...
module Twilio
  class UsageUsageRecordUsageRecordAllTime
    ...
    @[JSON::Field(key: "category", type: Twilio::UsageRecordAllTimeEnumCategory?, default: nil, required: false, nullable: false, emit_null: false)]
    getter category : Twilio::UsageRecordAllTimeEnumCategory? = nil
    ...
    def category=(category : Twilio::UsageRecordAllTimeEnumCategory?)
      if category.nil?
        return @category = nil
      end
