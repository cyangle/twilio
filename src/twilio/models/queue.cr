...
module Twilio
  class Queue
    ...
    def initialize(*, @account_sid : String? | Null = nil, @average_wait_time : Int32? | Null = nil, @current_size : Int32? | Null = nil, @date_created : Time? | Null = nil, @date_updated : Time? | Null = nil, @friendly_name : String? | Null = nil, @max_size : Int32? | Null = nil, @sid : String? | Null = nil, @uri : String? | Null = nil)
    end
