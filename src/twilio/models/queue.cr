...
module Twilio
  class Queue
    ...
    @[NASON::Field(key: "average_wait_time", type: Int32? | Null, nillable: true)]
    property average_wait_time : Int32? | Null

    # The number of calls currently in the queue.
    @[NASON::Field(key: "current_size", type: Int32? | Null, nillable: true)]
    property current_size : Int32? | Null
    ...
    @[NASON::Field(key: "max_size", type: Int32? | Null, nillable: true)]
    property max_size : Int32? | Null
    ...
    def initialize(*, @account_sid : String? | Null = nil, @average_wait_time : Int32? | Null = nil, @current_size : Int32? | Null = nil, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @friendly_name : String? | Null = nil, @max_size : Int32? | Null = nil, @sid : String? | Null = nil, @uri : String? | Null = nil)
    end
    ...
    def valid?
      ...
      return false if !@sid.nil? && !@sid.null? && @sid.to_s.size < 34
      return false if !@sid.nil? && !@sid.null? && @sid !~ /^QU[0-9a-fA-F]{32}$/
      true
    end
