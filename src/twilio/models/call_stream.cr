...
module Twilio
  class CallStream
    ...
    def initialize(*, @account_sid : String? | Null = nil, @call_sid : String? | Null = nil, @date_updated : Time? | Null = nil, @name : String? | Null = nil, @sid : String? | Null = nil, @status : String? | Null = nil, @uri : String? | Null = nil)
    end
    ...
    def valid?
      ...
      return false if !@sid.nil? && !@sid.null? && @sid.to_s.size < 34
      return false if !@sid.nil? && !@sid.null? && @sid !~ /^MZ[0-9a-fA-F]{32}$/
