...
module Twilio
  ...
  class ListCallNotificationResponse
    ...
    @[JSON::Field(key: "notifications", type: Array(CallCallNotification)?, presence: true, ignore_serialize: notifications.nil? && !notifications_present?)]
    ...
    def_equals_and_hash(@_end, @first_page_uri, @next_page_uri, @notifications, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
