...
module Twilio
  class ListCallNotificationResponse
    ...
    @[JSON::Field(key: "notifications", type: Array(CallCallNotification)?, presence: true, ignore_serialize: notifications.nil? && !notifications_present?, emit_null: true)]
    property notifications : Array(CallCallNotification)?
    @[JSON::Field(ignore: true)]
    property? notifications_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @notifications : Array(CallCallNotification)? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [_end, first_page_uri, next_page_uri, notifications, page, page_size, previous_page_uri, start, uri].hash
    end
