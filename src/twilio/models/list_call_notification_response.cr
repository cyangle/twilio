...
module Twilio
  class ListCallNotificationResponse
    ...
    @[NASON::Field(key: "notifications", type: Array(CallCallNotification)?, nillable: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @notifications : Array(CallCallNotification)? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
