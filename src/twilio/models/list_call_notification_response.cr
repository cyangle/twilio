...
module Twilio
  class ListCallNotificationResponse
    ...
    def_equals_and_hash(@notifications, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
