...
module Twilio
  class ListCallNotificationResponse
    ...
    @[JSON::Field(key: "notifications", type: Array(CallCallNotification)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter notifications : Array(CallCallNotification)? = nil
    ...
    def notifications=(notifications : Array(CallCallNotification)?)
