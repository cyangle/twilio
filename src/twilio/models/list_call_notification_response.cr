...
module Twilio
  class ListCallNotificationResponse
    ...
    @[JSON::Field(key: "notifications", type: Array(Twilio::CallCallNotification)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter notifications : Array(Twilio::CallCallNotification)? = nil
    ...
    def initialize(
      *,
      ...
      @notifications : Array(Twilio::CallCallNotification)? = nil,
      @page : Int32? = nil,
      @page_size : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_notifications = @notifications).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "notifications", container: _notifications)) if _notifications.is_a?(Array)
      end
    ...
    def valid? : Bool
      ...
      unless (_notifications = @notifications).nil?
        return false if _notifications.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _notifications)
      end
    ...
    def notifications=(notifications : Array(Twilio::CallCallNotification)?)
      if notifications.nil?
        return @notifications = nil
      end
      _notifications = notifications.not_nil!
      OpenApi::ContainerValidator.validate(container: _notifications) if _notifications.is_a?(Array)
    ...
    def_equals_and_hash(@_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @notifications, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
