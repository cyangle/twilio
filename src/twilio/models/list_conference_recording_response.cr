...
module Twilio
  ...
  class ListConferenceRecordingResponse
    ...
    @[JSON::Field(key: "recordings", type: Array(ConferenceConferenceRecording)?, presence: true, ignore_serialize: recordings.nil? && !recordings_present?)]
    ...
    def_equals_and_hash(@_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @recordings, @start, @uri)
  end
end
