...
module Twilio
  class ListConferenceRecordingResponse
    ...
    @[JSON::Field(key: "recordings", type: Array(ConferenceConferenceRecording)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter recordings : Array(ConferenceConferenceRecording)? = nil
    ...
    def recordings=(recordings : Array(ConferenceConferenceRecording)?)
      if recordings.nil?
