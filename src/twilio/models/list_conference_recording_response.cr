...
module Twilio
  class ListConferenceRecordingResponse
    ...
    @[JSON::Field(key: "recordings", type: Array(Twilio::ConferenceConferenceRecording)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter recordings : Array(Twilio::ConferenceConferenceRecording)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @recordings : Array(Twilio::ConferenceConferenceRecording)? = nil,
      @_end : Int32? = nil,
    ...
    def recordings=(recordings : Array(Twilio::ConferenceConferenceRecording)?)
      if recordings.nil?
        return @recordings = nil
      end
      _recordings = recordings.not_nil!
      OpenApi::ContainerValidator.validate(container: _recordings) if _recordings.is_a?(Array)
    ...
    def_equals_and_hash(@recordings, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
