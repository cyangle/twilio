...
module Twilio
  class ListConferenceRecordingResponse
    ...
    @[JSON::Field(key: "recordings", type: Array(ConferenceConferenceRecording)?, presence: true, ignore_serialize: recordings.nil? && !recordings_present?, emit_null: true)]
    property recordings : Array(ConferenceConferenceRecording)?
    @[JSON::Field(ignore: true)]
    property? recordings_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @recordings : Array(ConferenceConferenceRecording)? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [_end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, recordings, start, uri].hash
    end
