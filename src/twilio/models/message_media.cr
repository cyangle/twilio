...
module Twilio
  class MessageMedia
    ...
    def parent_sid=(parent_sid : String?)
      ...
      OpenApi::PrimitiveValidator.validate_max_length("parent_sid", _parent_sid.to_s.size, MAX_LENGTH_FOR_PARENT_SID)
      OpenApi::PrimitiveValidator.validate_min_length("parent_sid", _parent_sid.to_s.size, MIN_LENGTH_FOR_PARENT_SID)
      OpenApi::PrimitiveValidator.validate_pattern("parent_sid", _parent_sid, PATTERN_FOR_PARENT_SID)
