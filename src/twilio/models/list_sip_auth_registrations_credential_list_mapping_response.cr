...
module Twilio
  ...
  class ListSipAuthRegistrationsCredentialListMappingResponse
    ...
    @[JSON::Field(key: "contents", type: Array(SipSipDomainSipAuthSipAuthRegistrationsSipAuthRegistrationsCredentialListMapping)?, presence: true, ignore_serialize: contents.nil? && !contents_present?)]
    ...
    def initialize(
      *,
      # Optional properties
      @contents : Array(SipSipDomainSipAuthSipAuthRegistrationsSipAuthRegistrationsCredentialListMapping)? = nil,
      @_end : Int32? = nil,
