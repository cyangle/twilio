...
module Twilio
  class ListSipAuthRegistrationsCredentialListMappingResponse
    ...
    @[JSON::Field(key: "contents", type: Array(SipSipDomainSipAuthSipAuthRegistrationsSipAuthRegistrationsCredentialListMapping)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter contents : Array(SipSipDomainSipAuthSipAuthRegistrationsSipAuthRegistrationsCredentialListMapping)? = nil
    ...
    def contents=(contents : Array(SipSipDomainSipAuthSipAuthRegistrationsSipAuthRegistrationsCredentialListMapping)?)
      if contents.nil?
        return @contents = nil
      end
      @contents = contents
