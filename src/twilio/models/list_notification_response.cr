...
module Twilio
  class ListNotificationResponse
    ...
    @[NASON::Field(key: "notifications", type: Array(Notification)?, nillable: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @notifications : Array(Notification)? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
