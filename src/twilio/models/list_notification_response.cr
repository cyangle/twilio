...
module Twilio
  class ListNotificationResponse
    ...
    @[JSON::Field(key: "notifications", type: Array(Notification)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter notifications : Array(Notification)? = nil
    ...
    def notifications=(notifications : Array(Notification)?)
