...
module Twilio
  class ListNotificationResponse
    ...
    @[JSON::Field(key: "notifications", type: Array(Notification)?, presence: true, ignore_serialize: notifications.nil? && !notifications_present?, emit_null: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @notifications : Array(Notification)? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
