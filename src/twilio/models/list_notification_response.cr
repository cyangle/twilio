...
module Twilio
  class ListNotificationResponse
    ...
    @[JSON::Field(key: "notifications", type: Array(Twilio::Notification)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter notifications : Array(Twilio::Notification)? = nil
    ...
    def initialize(
      *,
      ...
      @notifications : Array(Twilio::Notification)? = nil,
      @page : Int32? = nil,
      @page_size : Int32? = nil,
    ...
    def notifications=(notifications : Array(Twilio::Notification)?)
