...
module Twilio
  class ListIncomingPhoneNumberAssignedAddOnResponse
    ...
    @[JSON::Field(key: "assigned_add_ons", type: Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOn)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter assigned_add_ons : Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOn)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @assigned_add_ons : Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOn)? = nil,
      @_end : Int32? = nil,
    ...
    def assigned_add_ons=(assigned_add_ons : Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOn)?)
