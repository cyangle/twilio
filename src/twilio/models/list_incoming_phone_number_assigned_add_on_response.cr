...
require "./incoming_phone_number_incoming_phone_number_assigned_add_on"
...
module Twilio
  class ListIncomingPhoneNumberAssignedAddOnResponse
    ...
    def assigned_add_ons=(new_value : Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberAssignedAddOn)?)
      unless new_value.nil?
        OpenApi::ContainerValidator.validate(container: new_value) if new_value.is_a?(Array)
      end

      @assigned_add_ons = new_value
    end
