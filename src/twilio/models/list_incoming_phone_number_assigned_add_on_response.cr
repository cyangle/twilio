...
module Twilio
  class ListIncomingPhoneNumberAssignedAddOnResponse
    ...
    @[JSON::Field(key: "assigned_add_ons", type: Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberAssignedAddOn)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter assigned_add_ons : Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberAssignedAddOn)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @assigned_add_ons : Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberAssignedAddOn)? = nil,
      @_end : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_assigned_add_ons = @assigned_add_ons).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "assigned_add_ons", container: _assigned_add_ons)) if _assigned_add_ons.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_assigned_add_ons = @assigned_add_ons).nil?
        return false if _assigned_add_ons.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _assigned_add_ons)
      end
    ...
    # @param [Object] assigned_add_ons Object to be assigned
    def assigned_add_ons=(assigned_add_ons : Array(Twilio::IncomingPhoneNumberIncomingPhoneNumberAssignedAddOn)?)
      if assigned_add_ons.nil?
        return @assigned_add_ons = nil
      end
      _assigned_add_ons = assigned_add_ons.not_nil!
      OpenApi::ContainerValidator.validate(container: _assigned_add_ons) if _assigned_add_ons.is_a?(Array)
      @assigned_add_ons = _assigned_add_ons
    end
    ...
    def_equals_and_hash(@assigned_add_ons, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
