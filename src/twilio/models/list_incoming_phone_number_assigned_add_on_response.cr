...
module Twilio
  class ListIncomingPhoneNumberAssignedAddOnResponse
    ...
    # Optional properties
    @[JSON::Field(key: "assigned_add_ons", type: Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOn)?, presence: true, ignore_serialize: assigned_add_ons.nil? && !assigned_add_ons_present?, emit_null: true)]
