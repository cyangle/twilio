...
module Twilio
  class ListIncomingPhoneNumberAssignedAddOnResponse
    ...
    # Optional properties
    @[NASON::Field(key: "assigned_add_ons", type: Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOn)?, nillable: true)]
    ...
    def initialize(*, @assigned_add_ons : Array(IncomingPhoneNumberIncomingPhoneNumberAssignedAddOn)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [assigned_add_ons, _end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
