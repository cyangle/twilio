...
module Twilio
  class Token
    ...
    def initialize(*, @account_sid : String? | Null = nil, @date_created : Time? | Null = nil, @date_updated : Time? | Null = nil, @ice_servers : Array(TokenIceServers)? | Null = nil, @password : String? | Null = nil, @ttl : String? | Null = nil, @username : String? | Null = nil)
    end
