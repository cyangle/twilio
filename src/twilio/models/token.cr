...
module Twilio
  class Token
    ...
    @[NASON::Field(key: "ice_servers", type: Array(TokenIceServers)? | Null, nillable: true)]
    property ice_servers : Array(TokenIceServers)? | Null
    ...
    def initialize(*, @account_sid : String? | Null = nil, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @ice_servers : Array(TokenIceServers)? | Null = nil, @password : String? | Null = nil, @ttl : String? | Null = nil, @username : String? | Null = nil)
    end
