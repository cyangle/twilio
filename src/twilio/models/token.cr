...
module Twilio
  class Token
    ...
    @[NASON::Field(key: "ice_servers", type: Array(TokenIceServersInner)? | Null, nillable: true)]
    property ice_servers : Array(TokenIceServersInner)? | Null

    # The temporary password used for authenticating
    @[NASON::Field(key: "password", type: String? | Null, nillable: true)]
    property password : String? | Null

    # The duration in seconds the credentials are valid
    @[NASON::Field(key: "ttl", type: String? | Null, nillable: true)]
    property ttl : String? | Null
    ...
    def initialize(*, @account_sid : String? | Null = nil, @date_created : Time? | Null = nil, @date_updated : Time? | Null = nil, @ice_servers : Array(TokenIceServersInner)? | Null = nil, @password : String? | Null = nil, @ttl : String? | Null = nil, @username : String? | Null = nil)
    end
    ...
    def hash
      [account_sid, date_created, date_updated, ice_servers, password, ttl, username].hash
    end
