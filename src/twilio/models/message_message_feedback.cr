...
module Twilio
  class MessageMessageFeedback
    ...
    @[JSON::Field(key: "message_sid", type: String?, presence: true, ignore_serialize: message_sid.nil? && !message_sid_present?, emit_null: true)]
    property message_sid : String?
    @[JSON::Field(ignore: true)]
    property? message_sid_present : Bool = false

    # Whether the feedback has arrived
    @[JSON::Field(key: "outcome", type: String?, presence: true, ignore_serialize: outcome.nil? && !outcome_present?, emit_null: true)]
