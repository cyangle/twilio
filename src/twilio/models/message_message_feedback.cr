...
module Twilio
  class MessageMessageFeedback
    ...
    def initialize(*, @account_sid : String? | Null = nil, @date_created : Time? | Null = nil, @date_updated : Time? | Null = nil, @message_sid : String? | Null = nil, @outcome : String? | Null = nil, @uri : String? | Null = nil)
    end
