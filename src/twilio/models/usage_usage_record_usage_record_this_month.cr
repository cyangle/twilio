...
module Twilio
  class UsageUsageRecordUsageRecordThisMonth
    ...
    @[JSON::Field(key: "category", type: Twilio::UsageRecordThisMonthEnumCategory?, default: nil, required: false, nullable: false, emit_null: false)]
    getter category : Twilio::UsageRecordThisMonthEnumCategory? = nil
    ...
    def category=(category : Twilio::UsageRecordThisMonthEnumCategory?)
      if category.nil?
        return @category = nil
      end
