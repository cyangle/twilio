...
module Twilio
  class ListCallEventResponse
    ...
    @[JSON::Field(key: "events", type: Array(CallCallEvent)?, presence: true, ignore_serialize: events.nil? && !events_present?, emit_null: true)]
    ...
    def hash
      [_end, events, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
