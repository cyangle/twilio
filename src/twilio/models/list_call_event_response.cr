...
module Twilio
  class ListCallEventResponse
    ...
    @[NASON::Field(key: "events", type: Array(CallCallEvent)?, nillable: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @events : Array(CallCallEvent)? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
