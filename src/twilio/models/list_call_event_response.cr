...
module Twilio
  class ListCallEventResponse
    ...
    @[JSON::Field(key: "events", type: Array(CallCallEvent)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter events : Array(CallCallEvent)? = nil
    ...
    def events=(events : Array(CallCallEvent)?)
      if events.nil?
        return @events = nil
      end
      @events = events
