...
module Twilio
  ...
  class ListCallEventResponse
    ...
    @[JSON::Field(key: "events", type: Array(CallCallEvent)?, presence: true, ignore_serialize: events.nil? && !events_present?)]
    property events : Array(CallCallEvent)?

    @[JSON::Field(ignore: true)]
    property? events_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @events : Array(CallCallEvent)? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def_equals_and_hash(@_end, @events, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
