  ...
  class ListCallEventResponse
    ...
    def initialize(
      *,
      # Optional properties
      @_end : Int32? = nil,
      @events : Array(CallCallEvent)? = nil,
    ...
    def_equals_and_hash(@_end, @_end_present, @events, @events_present, @first_page_uri, @first_page_uri_present, @next_page_uri, @next_page_uri_present, @page, @page_present, @page_size, @page_size_present, @previous_page_uri, @previous_page_uri_present, @start, @start_present, @uri, @uri_present)
  end
end
