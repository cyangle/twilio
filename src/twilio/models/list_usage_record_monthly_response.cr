...
module Twilio
  class ListUsageRecordMonthlyResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(UsageUsageRecordUsageRecordMonthly)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter usage_records : Array(UsageUsageRecordUsageRecordMonthly)? = nil
    ...
    def usage_records=(usage_records : Array(UsageUsageRecordUsageRecordMonthly)?)
