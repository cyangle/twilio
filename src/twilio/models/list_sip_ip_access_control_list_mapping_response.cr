...
module Twilio
  class ListSipIpAccessControlListMappingResponse
    ...
    @[JSON::Field(key: "ip_access_control_list_mappings", type: Array(SipSipDomainSipIpAccessControlListMapping)?, presence: true, ignore_serialize: ip_access_control_list_mappings.nil? && !ip_access_control_list_mappings_present?, emit_null: true)]
    property ip_access_control_list_mappings : Array(SipSipDomainSipIpAccessControlListMapping)?
    @[JSON::Field(ignore: true)]
    property? ip_access_control_list_mappings_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @ip_access_control_list_mappings : Array(SipSipDomainSipIpAccessControlListMapping)? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        ...
        ip_access_control_list_mappings == o.ip_access_control_list_mappings &&
    ...
    def hash
      [_end, first_page_uri, ip_access_control_list_mappings, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
