...
module Twilio
  class ListSipIpAccessControlListMappingResponse
    ...
    @[NASON::Field(key: "ip_access_control_list_mappings", type: Array(SipSipDomainSipIpAccessControlListMapping)?, nillable: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @ip_access_control_list_mappings : Array(SipSipDomainSipIpAccessControlListMapping)? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
