...
module Twilio
  ...
  class ListSipIpAccessControlListMappingResponse
    ...
    @[JSON::Field(key: "ip_access_control_list_mappings", type: Array(SipSipDomainSipIpAccessControlListMapping)?, presence: true, ignore_serialize: ip_access_control_list_mappings.nil? && !ip_access_control_list_mappings_present?)]
    ...
    def_hash(@_end, @first_page_uri, @ip_access_control_list_mappings, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
