...
module Twilio
  class ListSipIpAccessControlListMappingResponse
    ...
    @[JSON::Field(key: "ip_access_control_list_mappings", type: Array(SipSipDomainSipIpAccessControlListMapping)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter ip_access_control_list_mappings : Array(SipSipDomainSipIpAccessControlListMapping)? = nil
    ...
    def initialize(
      *,
      ...
      @ip_access_control_list_mappings : Array(SipSipDomainSipIpAccessControlListMapping)? = nil,
    ...
    def ip_access_control_list_mappings=(ip_access_control_list_mappings : Array(SipSipDomainSipIpAccessControlListMapping)?)
