...
require "./sip_sip_domain_sip_ip_access_control_list_mapping"
...
module Twilio
  class ListSipIpAccessControlListMappingResponse
    ...
    def ip_access_control_list_mappings=(new_value : Array(Twilio::SipSipDomainSipIpAccessControlListMapping)?)
      unless new_value.nil?
        OpenApi::ContainerValidator.validate(container: new_value) if new_value.is_a?(Array)
      end

      @ip_access_control_list_mappings = new_value
    end
