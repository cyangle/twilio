...
module Twilio
  class UsageUsageRecordUsageRecordMonthly
    ...
    @[JSON::Field(key: "category", type: Twilio::UsageRecordMonthlyEnumCategory?, default: nil, required: false, nullable: false, emit_null: false)]
    getter category : Twilio::UsageRecordMonthlyEnumCategory? = nil
    ...
    def category=(category : Twilio::UsageRecordMonthlyEnumCategory?)
      if category.nil?
        return @category = nil
      end
