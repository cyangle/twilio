...
module Twilio
  class ListParticipantResponse
    ...
    @[JSON::Field(key: "participants", type: Array(ConferenceParticipant)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter participants : Array(ConferenceParticipant)? = nil
    ...
    def participants=(participants : Array(ConferenceParticipant)?)
      if participants.nil?
