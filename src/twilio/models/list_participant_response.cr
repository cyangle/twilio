...
module Twilio
  ...
  class ListParticipantResponse
    ...
    @[JSON::Field(key: "participants", type: Array(ConferenceParticipant)?, presence: true, ignore_serialize: participants.nil? && !participants_present?)]
    property participants : Array(ConferenceParticipant)?

    @[JSON::Field(ignore: true)]
    property? participants_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @participants : Array(ConferenceParticipant)? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def_equals_and_hash(@_end, @first_page_uri, @next_page_uri, @page, @page_size, @participants, @previous_page_uri, @start, @uri)
  end
end
