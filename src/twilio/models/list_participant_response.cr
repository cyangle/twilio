...
module Twilio
  class ListParticipantResponse
    ...
    @[JSON::Field(key: "participants", type: Array(Twilio::ConferenceParticipant)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter participants : Array(Twilio::ConferenceParticipant)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @participants : Array(Twilio::ConferenceParticipant)? = nil,
      @_end : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_participants = @participants).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "participants", container: _participants)) if _participants.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_participants = @participants).nil?
        return false if _participants.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _participants)
      end
    ...
    def participants=(participants : Array(Twilio::ConferenceParticipant)?)
      if participants.nil?
        return @participants = nil
      end
      _participants = participants.not_nil!
      OpenApi::ContainerValidator.validate(container: _participants) if _participants.is_a?(Array)
    ...
    def_equals_and_hash(@participants, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
