...
module Twilio
  class ListParticipantResponse
    ...
    @[NASON::Field(key: "participants", type: Array(ConferenceParticipant)?, nillable: true)]
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @participants : Array(ConferenceParticipant)? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
