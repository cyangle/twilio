...
module Twilio
  class ListParticipantResponse
    ...
    @[JSON::Field(key: "participants", type: Array(ConferenceParticipant)?, presence: true, ignore_serialize: participants.nil? && !participants_present?, emit_null: true)]
    ...
    def hash
      [_end, first_page_uri, next_page_uri, page, page_size, participants, previous_page_uri, start, uri].hash
    end
