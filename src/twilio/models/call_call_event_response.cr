...
module Twilio
  ...
  class CallCallEventResponse
    ...
    # Optional properties
    @[NASON::Field(key: "response_code", type: Int32? | Null, nillable: true)]
    property response_code : Int32? | Null

    @[NASON::Field(key: "request_duration", type: Int32? | Null, nillable: true)]
    property request_duration : Int32? | Null
