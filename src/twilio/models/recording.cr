...
module Twilio
  class Recording
    ...
    def initialize(*, @account_sid : String? | Null = nil, @api_version : String? | Null = nil, @call_sid : String? | Null = nil, @channels : Int32? | Null = nil, @conference_sid : String? | Null = nil, @date_created : Time? | Null = nil, @date_updated : Time? | Null = nil, @duration : String? | Null = nil, @encryption_details : EncryptionDetails? | Null = nil, @error_code : Int32? | Null = nil, @price : String? | Null = nil, @price_unit : String? | Null = nil, @sid : String? | Null = nil, @source : String? | Null = nil, @start_time : Time? | Null = nil, @status : String? | Null = nil, @subresource_uris : Hash(String, String)? | Null = nil, @uri : String? | Null = nil)
    end
    ...
    def hash
      [account_sid, api_version, call_sid, channels, conference_sid, date_created, date_updated, duration, encryption_details, error_code, price, price_unit, sid, source, start_time, status, subresource_uris, uri].hash
    end
