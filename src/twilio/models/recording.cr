...
module Twilio
  ...
  class Recording
    ...
    def valid?
      ...
      status_validator = EnumValidator.new("String", ["in-progress", "paused", "stopped", "processing", "completed", "absent", "deleted"])
    ...
    def status=(status)
      validator = EnumValidator.new("String", ["in-progress", "paused", "stopped", "processing", "completed", "absent", "deleted"])
