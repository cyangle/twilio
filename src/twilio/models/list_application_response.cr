...
module Twilio
  class ListApplicationResponse
    ...
    @[JSON::Field(key: "applications", type: Array(Twilio::Application)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter applications : Array(Twilio::Application)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @applications : Array(Twilio::Application)? = nil,
      @_end : Int32? = nil,
    ...
    def applications=(applications : Array(Twilio::Application)?)
      if applications.nil?
        return @applications = nil
      end
      _applications = applications.not_nil!
      OpenApi::ContainerValidator.validate(container: _applications) if _applications.is_a?(Array)
    ...
    def_equals_and_hash(@applications, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
