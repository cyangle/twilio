...
module Twilio
  class ListApplicationResponse
    ...
    # Optional properties
    @[NASON::Field(key: "applications", type: Array(Application)?, nillable: true)]
    ...
    def initialize(*, @applications : Array(Application)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? | Null = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? | Null = nil, @start : Int32? = nil, @uri : String? = nil)
    end
