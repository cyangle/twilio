...
module Twilio
  class ListApplicationResponse
    ...
    # Optional properties
    @[JSON::Field(key: "applications", type: Array(Application)?, presence: true, ignore_serialize: applications.nil? && !applications_present?, emit_null: true)]
    property applications : Array(Application)?
    @[JSON::Field(ignore: true)]
    property? applications_present : Bool = false
    ...
    def initialize(*, @applications : Array(Application)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [applications, _end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
