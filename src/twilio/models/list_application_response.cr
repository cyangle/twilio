...
module Twilio
  ...
  class ListApplicationResponse
    ...
    # Optional properties
    @[JSON::Field(key: "applications", type: Array(Application)?, presence: true, ignore_serialize: applications.nil? && !applications_present?)]
    ...
    def_equals_and_hash(@applications, @_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
