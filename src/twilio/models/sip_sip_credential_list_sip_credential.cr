...
module Twilio
  class SipSipCredentialListSipCredential
    ...
    def initialize(*, @account_sid : String? | Null = nil, @credential_list_sid : String? | Null = nil, @date_created : Time? | Null = nil, @date_updated : Time? | Null = nil, @sid : String? | Null = nil, @uri : String? | Null = nil, @username : String? | Null = nil)
    end
