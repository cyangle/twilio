...
module Twilio
  class ListUsageRecordTodayResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(UsageUsageRecordUsageRecordToday)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter usage_records : Array(UsageUsageRecordUsageRecordToday)? = nil
    ...
    def usage_records=(usage_records : Array(UsageUsageRecordUsageRecordToday)?)
