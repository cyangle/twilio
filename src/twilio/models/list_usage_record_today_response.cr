...
module Twilio
  class ListUsageRecordTodayResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(UsageUsageRecordUsageRecordToday)?, presence: true, ignore_serialize: usage_records.nil? && !usage_records_present?, emit_null: true)]
    property usage_records : Array(UsageUsageRecordUsageRecordToday)?
    @[JSON::Field(ignore: true)]
    property? usage_records_present : Bool = false

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil, @usage_records : Array(UsageUsageRecordUsageRecordToday)? = nil)
    end
