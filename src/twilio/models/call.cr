...
module Twilio
  class Call
    ...
    # The _annotation provided for the call
    @[NASON::Field(key: "annotation", type: String? | Null, nillable: true)]
    property _annotation : String? | Null
    ...
    @[NASON::Field(key: "end_time", type: String? | Null, nillable: true)]
    property end_time : String? | Null
    ...
    @[NASON::Field(key: "start_time", type: String? | Null, nillable: true)]
    property start_time : String? | Null
    ...
    def hash
      [account_sid, _annotation, answered_by, api_version, caller_name, date_created, date_updated, direction, duration, end_time, forwarded_from, from, from_formatted, group_sid, parent_call_sid, phone_number_sid, price, price_unit, queue_time, sid, start_time, status, subresource_uris, to, to_formatted, trunk_sid, uri].hash
    end
