...
module Twilio
  class ListAvailablePhoneNumberTollFreeResponse
    ...
    # Optional properties
    @[JSON::Field(key: "available_phone_numbers", type: Array(AvailablePhoneNumberCountryAvailablePhoneNumberTollFree)?, presence: true, ignore_serialize: available_phone_numbers.nil? && !available_phone_numbers_present?, emit_null: true)]
