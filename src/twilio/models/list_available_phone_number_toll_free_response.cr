...
module Twilio
  class ListAvailablePhoneNumberTollFreeResponse
    ...
    @[JSON::Field(key: "available_phone_numbers", type: Array(AvailablePhoneNumberCountryAvailablePhoneNumberTollFree)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter available_phone_numbers : Array(AvailablePhoneNumberCountryAvailablePhoneNumberTollFree)? = nil
    ...
    def available_phone_numbers=(available_phone_numbers : Array(AvailablePhoneNumberCountryAvailablePhoneNumberTollFree)?)
