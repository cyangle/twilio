...
module Twilio
  ...
  class ListAvailablePhoneNumberTollFreeResponse
    ...
    # Optional properties
    @[JSON::Field(key: "available_phone_numbers", type: Array(AvailablePhoneNumberCountryAvailablePhoneNumberTollFree)?, presence: true, ignore_serialize: available_phone_numbers.nil? && !available_phone_numbers_present?)]
    property available_phone_numbers : Array(AvailablePhoneNumberCountryAvailablePhoneNumberTollFree)?
    ...
    def initialize(*, @available_phone_numbers : Array(AvailablePhoneNumberCountryAvailablePhoneNumberTollFree)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
