...
module Twilio
  class ListAvailablePhoneNumberTollFreeResponse
    ...
    @[JSON::Field(key: "available_phone_numbers", type: Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberTollFree)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter available_phone_numbers : Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberTollFree)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @available_phone_numbers : Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberTollFree)? = nil,
      @_end : Int32? = nil,
    ...
    def available_phone_numbers=(available_phone_numbers : Array(Twilio::AvailablePhoneNumberCountryAvailablePhoneNumberTollFree)?)
