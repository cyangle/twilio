...
module Twilio
  class ListIncomingPhoneNumberResponse
    ...
    @[JSON::Field(key: "incoming_phone_numbers", type: Array(IncomingPhoneNumber)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter incoming_phone_numbers : Array(IncomingPhoneNumber)? = nil
    ...
    def initialize(
      *,
      ...
      @incoming_phone_numbers : Array(IncomingPhoneNumber)? = nil,
    ...
    def incoming_phone_numbers=(incoming_phone_numbers : Array(IncomingPhoneNumber)?)
