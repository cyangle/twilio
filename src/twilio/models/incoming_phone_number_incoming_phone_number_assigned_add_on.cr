...
module Twilio
  class IncomingPhoneNumberIncomingPhoneNumberAssignedAddOn
    ...
    def initialize(*, @account_sid : String? | Null = nil, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @description : String? | Null = nil, @friendly_name : String? | Null = nil, @resource_sid : String? | Null = nil, @sid : String? | Null = nil, @subresource_uris : SubresourceUris? | Null = nil, @unique_name : String? | Null = nil, @uri : String? | Null = nil)
    end
    ...
    def valid?
      ...
      return false if !@sid.nil? && !@sid.null? && @sid.to_s.size < 34
      return false if !@sid.nil? && !@sid.null? && @sid !~ /^XE[0-9a-fA-F]{32}$/
      true
    end
