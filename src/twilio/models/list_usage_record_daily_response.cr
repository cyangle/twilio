...
module Twilio
  class ListUsageRecordDailyResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(UsageUsageRecordUsageRecordDaily)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter usage_records : Array(UsageUsageRecordUsageRecordDaily)? = nil
    ...
    def usage_records=(usage_records : Array(UsageUsageRecordUsageRecordDaily)?)
