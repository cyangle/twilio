...
module Twilio
  class ListUsageRecordDailyResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(Twilio::UsageUsageRecordUsageRecordDaily)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter usage_records : Array(Twilio::UsageUsageRecordUsageRecordDaily)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @usage_records : Array(Twilio::UsageUsageRecordUsageRecordDaily)? = nil,
      @_end : Int32? = nil,
    ...
    def usage_records=(usage_records : Array(Twilio::UsageUsageRecordUsageRecordDaily)?)
