...
module Twilio
  class ListAvailablePhoneNumberCountryResponse
    ...
    @[JSON::Field(key: "countries", type: Array(AvailablePhoneNumberCountry)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter countries : Array(AvailablePhoneNumberCountry)? = nil
    ...
    def countries=(countries : Array(AvailablePhoneNumberCountry)?)
      if countries.nil?
