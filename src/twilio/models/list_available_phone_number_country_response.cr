...
module Twilio
  ...
  class ListAvailablePhoneNumberCountryResponse
    ...
    # Optional properties
    @[JSON::Field(key: "countries", type: Array(AvailablePhoneNumberCountry)?, presence: true, ignore_serialize: countries.nil? && !countries_present?)]
    ...
    def_equals_and_hash(@countries, @_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
