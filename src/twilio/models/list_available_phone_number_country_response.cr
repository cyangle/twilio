...
module Twilio
  class ListAvailablePhoneNumberCountryResponse
    ...
    # Optional properties
    @[JSON::Field(key: "countries", type: Array(AvailablePhoneNumberCountry)?, presence: true, ignore_serialize: countries.nil? && !countries_present?, emit_null: true)]
    property countries : Array(AvailablePhoneNumberCountry)?
    ...
    def initialize(*, @countries : Array(AvailablePhoneNumberCountry)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [countries, _end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
