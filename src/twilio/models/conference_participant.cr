...
module Twilio
  class ConferenceParticipant
    ...
    def initialize(*, @account_sid : String? | Null = nil, @call_sid : String? | Null = nil, @call_sid_to_coach : String? | Null = nil, @coaching : Bool? | Null = nil, @conference_sid : String? | Null = nil, @date_created : String? | Null = nil, @date_updated : String? | Null = nil, @end_conference_on_exit : Bool? | Null = nil, @hold : Bool? | Null = nil, @label : String? | Null = nil, @muted : Bool? | Null = nil, @start_conference_on_enter : Bool? | Null = nil, @status : String? | Null = nil, @uri : String? | Null = nil)
    end
