...
module Twilio
  class ListUsageRecordAllTimeResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(UsageUsageRecordUsageRecordAllTime)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter usage_records : Array(UsageUsageRecordUsageRecordAllTime)? = nil
    ...
    def usage_records=(usage_records : Array(UsageUsageRecordUsageRecordAllTime)?)
