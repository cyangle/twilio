...
module Twilio
  class ListUsageRecordAllTimeResponse
    ...
    @[JSON::Field(key: "usage_records", type: Array(Twilio::UsageUsageRecordUsageRecordAllTime)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter usage_records : Array(Twilio::UsageUsageRecordUsageRecordAllTime)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @usage_records : Array(Twilio::UsageUsageRecordUsageRecordAllTime)? = nil,
      @_end : Int32? = nil,
    ...
    def usage_records=(usage_records : Array(Twilio::UsageUsageRecordUsageRecordAllTime)?)
