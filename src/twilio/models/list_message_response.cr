...
module Twilio
  class ListMessageResponse
    ...
    @[JSON::Field(key: "messages", type: Array(Message)?, presence: true, ignore_serialize: messages.nil? && !messages_present?, emit_null: true)]
    ...
    def hash
      [_end, first_page_uri, messages, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
