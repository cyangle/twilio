...
module Twilio
  ...
  class ListMessageResponse
    ...
    @[JSON::Field(key: "messages", type: Array(Message)?, presence: true, ignore_serialize: messages.nil? && !messages_present?)]
    property messages : Array(Message)?

    @[JSON::Field(ignore: true)]
    property? messages_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @messages : Array(Message)? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def_equals_and_hash(@_end, @first_page_uri, @messages, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
