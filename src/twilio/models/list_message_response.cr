...
module Twilio
  class ListMessageResponse
    ...
    @[JSON::Field(key: "messages", type: Array(Twilio::Message)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter messages : Array(Twilio::Message)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @messages : Array(Twilio::Message)? = nil,
      @_end : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_messages = @messages).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "messages", container: _messages)) if _messages.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_messages = @messages).nil?
        return false if _messages.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _messages)
      end
    ...
    def messages=(messages : Array(Twilio::Message)?)
      if messages.nil?
        return @messages = nil
      end
      _messages = messages.not_nil!
      OpenApi::ContainerValidator.validate(container: _messages) if _messages.is_a?(Array)
      @messages = _messages
    end
    ...
    def_equals_and_hash(@messages, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
