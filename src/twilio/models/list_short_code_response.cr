...
module Twilio
  class ListShortCodeResponse
    ...
    def_equals_and_hash(@_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @short_codes, @start, @uri)
  end
end
