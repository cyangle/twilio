...
module Twilio
  ...
  class ListShortCodeResponse
    ...
    @[JSON::Field(key: "short_codes", type: Array(ShortCode)?, presence: true, ignore_serialize: short_codes.nil? && !short_codes_present?)]
    ...
    def initialize(
      *,
      ...
      @short_codes : Array(ShortCode)? = nil,
      @start : Int32? = nil,
      @uri : String? = nil
    )
    end
    ...
    def_equals_and_hash(@_end, @_end_present, @first_page_uri, @first_page_uri_present, @next_page_uri, @next_page_uri_present, @page, @page_present, @page_size, @page_size_present, @previous_page_uri, @previous_page_uri_present, @short_codes, @short_codes_present, @start, @start_present, @uri, @uri_present)
  end
end
