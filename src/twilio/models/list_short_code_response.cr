...
module Twilio
  class ListShortCodeResponse
    ...
    @[JSON::Field(key: "short_codes", type: Array(ShortCode)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter short_codes : Array(ShortCode)? = nil
    ...
    def short_codes=(short_codes : Array(ShortCode)?)
      if short_codes.nil?
