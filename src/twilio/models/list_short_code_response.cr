...
module Twilio
  class ListShortCodeResponse
    ...
    @[JSON::Field(key: "short_codes", type: Array(Twilio::ShortCode)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter short_codes : Array(Twilio::ShortCode)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @short_codes : Array(Twilio::ShortCode)? = nil,
      @_end : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_short_codes = @short_codes).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "short_codes", container: _short_codes)) if _short_codes.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_short_codes = @short_codes).nil?
        return false if _short_codes.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _short_codes)
      end
    ...
    # @param [Object] short_codes Object to be assigned
    def short_codes=(short_codes : Array(Twilio::ShortCode)?)
      if short_codes.nil?
        return @short_codes = nil
      end
      _short_codes = short_codes.not_nil!
      OpenApi::ContainerValidator.validate(container: _short_codes) if _short_codes.is_a?(Array)
    ...
    def_equals_and_hash(@short_codes, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
