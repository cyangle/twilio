...
module Twilio
  class ListShortCodeResponse
    ...
    @[JSON::Field(key: "short_codes", type: Array(ShortCode)?, presence: true, ignore_serialize: short_codes.nil? && !short_codes_present?, emit_null: true)]
    property short_codes : Array(ShortCode)?
    @[JSON::Field(ignore: true)]
    property? short_codes_present : Bool = false
    ...
    def initialize(*, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @short_codes : Array(ShortCode)? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [_end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, short_codes, start, uri].hash
    end
