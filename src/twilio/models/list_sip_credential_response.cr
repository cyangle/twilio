...
module Twilio
  class ListSipCredentialResponse
    ...
    @[JSON::Field(key: "credentials", type: Array(Twilio::SipSipCredentialListSipCredential)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter credentials : Array(Twilio::SipSipCredentialListSipCredential)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @credentials : Array(Twilio::SipSipCredentialListSipCredential)? = nil,
      @_end : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_credentials = @credentials).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "credentials", container: _credentials)) if _credentials.is_a?(Array)
      end
    ...
    def valid? : Bool
      unless (_credentials = @credentials).nil?
        return false if _credentials.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _credentials)
      end
    ...
    # @param [Object] credentials Object to be assigned
    def credentials=(credentials : Array(Twilio::SipSipCredentialListSipCredential)?)
      if credentials.nil?
        return @credentials = nil
      end
      _credentials = credentials.not_nil!
      OpenApi::ContainerValidator.validate(container: _credentials) if _credentials.is_a?(Array)
    ...
    def_equals_and_hash(@credentials, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
