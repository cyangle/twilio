...
module Twilio
  class ListSipCredentialResponse
    ...
    # Optional properties
    @[JSON::Field(key: "credentials", type: Array(SipSipCredentialListSipCredential)?, presence: true, ignore_serialize: credentials.nil? && !credentials_present?, emit_null: true)]
    property credentials : Array(SipSipCredentialListSipCredential)?
    @[JSON::Field(ignore: true)]
    property? credentials_present : Bool = false
    ...
    def initialize(*, @credentials : Array(SipSipCredentialListSipCredential)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def hash
      [credentials, _end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
