...
module Twilio
  class UsageUsageRecordUsageRecordDaily
    ...
    @[JSON::Field(key: "category", type: Twilio::UsageRecordDailyEnumCategory?, default: nil, required: false, nullable: false, emit_null: false)]
    getter category : Twilio::UsageRecordDailyEnumCategory? = nil
    ...
    def category=(category : Twilio::UsageRecordDailyEnumCategory?)
      if category.nil?
        return @category = nil
      end
