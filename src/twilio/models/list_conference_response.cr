...
module Twilio
  ...
  class ListConferenceResponse
    ...
    # Optional properties
    @[JSON::Field(key: "conferences", type: Array(Conference)?, presence: true, ignore_serialize: conferences.nil? && !conferences_present?)]
    property conferences : Array(Conference)?

    @[JSON::Field(ignore: true)]
    property? conferences_present : Bool = false
    ...
    def initialize(*, @conferences : Array(Conference)? = nil, @_end : Int32? = nil, @first_page_uri : String? = nil, @next_page_uri : String? = nil, @page : Int32? = nil, @page_size : Int32? = nil, @previous_page_uri : String? = nil, @start : Int32? = nil, @uri : String? = nil)
    end
    ...
    def_equals_and_hash(@conferences, @_end, @first_page_uri, @next_page_uri, @page, @page_size, @previous_page_uri, @start, @uri)
  end
end
