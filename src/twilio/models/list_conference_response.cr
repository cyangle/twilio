...
module Twilio
  class ListConferenceResponse
    ...
    @[JSON::Field(key: "conferences", type: Array(Conference)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter conferences : Array(Conference)? = nil
    ...
    def conferences=(conferences : Array(Conference)?)
      if conferences.nil?
    ...
    def_equals_and_hash(@conferences, @_end, @first_page_uri, @next_page_uri, @next_page_uri_present, @page, @page_size, @previous_page_uri, @previous_page_uri_present, @start, @uri)
  end
end
