...
module Twilio
  class ListConferenceResponse
    ...
    # Optional properties
    @[JSON::Field(key: "conferences", type: Array(Conference)?, presence: true, ignore_serialize: conferences.nil? && !conferences_present?, emit_null: true)]
    ...
    def hash
      [conferences, _end, first_page_uri, next_page_uri, page, page_size, previous_page_uri, start, uri].hash
    end
