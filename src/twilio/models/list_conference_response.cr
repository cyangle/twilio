...
module Twilio
  class ListConferenceResponse
    ...
    @[JSON::Field(key: "conferences", type: Array(Twilio::Conference)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter conferences : Array(Twilio::Conference)? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @conferences : Array(Twilio::Conference)? = nil,
      @_end : Int32? = nil,
