...
# Unit tests for Twilio::UsageUsageRecordUsageRecordYearly
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Twilio::UsageUsageRecordUsageRecordYearly do
  describe "test an instance of UsageUsageRecordUsageRecordYearly" do
    it "should create an instance of UsageUsageRecordUsageRecordYearly" do
      # instance = Twilio::UsageUsageRecordUsageRecordYearly.new
      # expect(instance).to be_instance_of(Twilio::UsageUsageRecordUsageRecordYearly)
    end
  end
