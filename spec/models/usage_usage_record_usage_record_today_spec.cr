...
# Unit tests for Twilio::UsageUsageRecordUsageRecordToday
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Twilio::UsageUsageRecordUsageRecordToday do
  describe "test an instance of UsageUsageRecordUsageRecordToday" do
    it "should create an instance of UsageUsageRecordUsageRecordToday" do
      # instance = Twilio::UsageUsageRecordUsageRecordToday.new
      # expect(instance).to be_instance_of(Twilio::UsageUsageRecordUsageRecordToday)
    end
  end
