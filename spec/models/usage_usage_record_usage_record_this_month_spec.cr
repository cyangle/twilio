...
# Unit tests for Twilio::UsageUsageRecordUsageRecordThisMonth
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Twilio::UsageUsageRecordUsageRecordThisMonth do
  describe "test an instance of UsageUsageRecordUsageRecordThisMonth" do
    it "should create an instance of UsageUsageRecordUsageRecordThisMonth" do
      # instance = Twilio::UsageUsageRecordUsageRecordThisMonth.new
      # expect(instance).to be_instance_of(Twilio::UsageUsageRecordUsageRecordThisMonth)
    end
  end
