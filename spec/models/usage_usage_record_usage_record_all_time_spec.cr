...
# Unit tests for Twilio::UsageUsageRecordUsageRecordAllTime
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Twilio::UsageUsageRecordUsageRecordAllTime do
  describe "test an instance of UsageUsageRecordUsageRecordAllTime" do
    it "should create an instance of UsageUsageRecordUsageRecordAllTime" do
      # instance = Twilio::UsageUsageRecordUsageRecordAllTime.new
      # expect(instance).to be_instance_of(Twilio::UsageUsageRecordUsageRecordAllTime)
    end
  end
