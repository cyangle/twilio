...
describe Twilio::UsageUsageTrigger do
  describe "test an instance of UsageUsageTrigger" do
    it "should create an instance of UsageUsageTrigger" do
      ...
      # expect(instance).to be_instance_of(Twilio::UsageUsageTrigger)
    end
  end
  ...
  describe "test attribute 'recurring'" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Petstore::EnumTest::EnumAttributeValidator.new("String", ["daily", "monthly", "yearly", "alltime"])
      # validator.allowable_values.each do |value|
      #   expect { instance.recurring = value }.not_to raise_error
      # end
    end
  end
  ...
  describe "test attribute 'trigger_by'" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Petstore::EnumTest::EnumAttributeValidator.new("String", ["count", "usage", "price"])
      # validator.allowable_values.each do |value|
      #   expect { instance.trigger_by = value }.not_to raise_error
      # end
    end
  end
