...
# Unit tests for Twilio::UsageUsageRecordUsageRecordYesterday
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Twilio::UsageUsageRecordUsageRecordYesterday do
  describe "test an instance of UsageUsageRecordUsageRecordYesterday" do
    it "should create an instance of UsageUsageRecordUsageRecordYesterday" do
      # instance = Twilio::UsageUsageRecordUsageRecordYesterday.new
      # expect(instance).to be_instance_of(Twilio::UsageUsageRecordUsageRecordYesterday)
    end
  end
