...
# Unit tests for Twilio::UsageUsageRecordUsageRecordDaily
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Twilio::UsageUsageRecordUsageRecordDaily do
  describe "test an instance of UsageUsageRecordUsageRecordDaily" do
    it "should create an instance of UsageUsageRecordUsageRecordDaily" do
      # instance = Twilio::UsageUsageRecordUsageRecordDaily.new
      # expect(instance).to be_instance_of(Twilio::UsageUsageRecordUsageRecordDaily)
    end
  end
